...
`;function bt(t,e){const n=function(t){return Object.keys(t.chats).sort((e,n)=>{const i=e=>{const n=t.chats[e];return n?.length?n[n.length-1].ts:""};return i(n).localeCompare(i(e))})}(t);if(!n.length)return W`
      <h2 class="screen-title">${e("tab.chat")}</h2>
      <div class="empty">${e("chat.empty")}</div>
    `;const i=t.thread&&t.chats[t.thread]?t.thread:n[0],s=t.chats[i]??[];return W`
    <h2 class="screen-title">${e("tab.chat")}</h2>
    ...
    <div class="chips" style="margin-bottom:12px">
      ${n.map(n=>W`
          <button
            ...
            @click=${()=>t.onSelect(n)}
          >
            ${function(t,e,n){const[i,s]=t.split(":",2);if("channel"===i){const t=Number(s),i=e.channels.find(e=>e.index===t);return i?`${t}: ${i.name}`:`${n("settings.channel")} ${s}`}const o=e.nodes.find(t=>String(t.node_num)===s);return o?o.name:s}(n,t,e)}
          </button>
        `)}
    </div>
    ...
    <div class="actions">
      <button class="btn danger" @click=${()=>t.onClear(i)}>
        ${e("chat.clear")}
      </button>
    </div>

    <div class="hint">${e("chat.note")}</div>
  `}const wt="meshtastic",xt="hermes";function kt(t,e){const n=t.entities;return n?Object.values(n).filter(t=>t.platform===e):Object.keys(t.states).filter(t=>t.includes(e)).map(t=>({entity_id:t,platform:e}))}function zt(t,e){for(const n of kt(t,xt))if(n.entity_id.endsWith(e)){const e=t.states[n.entity_id];if(e)return e}}function Pt(t,e){const n=t.devices?.[e];if(!n?.identifiers)return null;for(const t of n.identifiers)if(t?.[0]===wt){const e=Number.parseInt(String(t[1]),10);return Number.isNaN(e)?null:e}return null}function $t(t){const e=(t.split(".")[1]??t).split("_");return e.slice(Math.max(e.length-2,0)).join(" ")}function St(t){const e=new Map;for(const n of kt(t,wt)){const i=n.device_id;if(!i)continue;const s=t.states[n.entity_id];if(!s)continue;let o=e.get(i);if(!o){const n=t.devices?.[i];o={deviceId:i,nodeNum:Pt(t,i),name:n?.name_by_user||n?.name||s.attributes?.friendly_name||i,values:{}},e.set(i,o)}o.values[$t(n.entity_id)]=s}return[...e.values()].sort((t,e)=>t.name.localeCompare(e.name))}function Lt(t,e,n=120){if(!e)return!1;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return!1;const s=Date.parse(i.state);return!Number.isNaN(s)&&Date.now()-s<=60*n*1e3}const Tt=[/\{state:([^:}]+)\}/g,/\{attr:([^:}]+):[^}]+\}/g,/\{do:[^:}]+:([^:}]+?)(?::[^}]*)?\}/g];const At=["battery","voltage","snr","hops","last_heard","utilization","uptime"];function Et(t){const e=t.attributes?.unit_of_measurement;return e?`${t.state} ${e}`:t.state}function Ct(t,e){const n=St(t);return n.length?W`
    ...
    <div class="grid">
      ${n.map(t=>W`
          <div class="panel">
            ...
            ${function(t){const{headline:e,rest:n}=function(t){const e=Object.entries(t),n=t=>At.findIndex(e=>t.toLowerCase().includes(e)),i=e.filter(([t])=>n(t)>=0).sort((t,e)=>n(t[0])-n(e[0]));return{headline:i,rest:e.filter(([t])=>n(t)<0)}}(t);return W`
    <div class="rows">
      ${[...e,...n].map(([t,e])=>W`
          <div class="row">
            <span class="k">${t}</span>
  ...
  `:W`<div class="empty">${e("devices.empty")}</div>`}const Mt="missing";function Ht(t,e){const n=function(t){const e=new Map,n=(t,n)=>{const i=t.trim();if(!i.includes("."))return;const s=e.get(i)??[];s.includes(n)||s.push(n),e.set(i,s)};for(const e of t)for(const t of e.commands??[]){const e=t.keyword||"?",i=t.target?.entity_id;"string"==typeof i&&n(i,e);const s=t.reply_template??"";for(const t of Tt){let i;for(t.lastIndex=0;null!==(i=t.exec(s));)n(i[1],e)}}return new Map([...e.entries()].sort((t,e)=>t[0].localeCompare(e[0])))}(t.entries),i=function(t){const e=[];for(const n of kt(t,xt)){const i=t.states[n.entity_id];i&&e.push(i)}return e.sort((t,e)=>t.entity_id.localeCompare(e.entity_id))}(t.hass),s=[...n.entries()].map(([e,n])=>{const i=t.hass.states[e];return{entityId:e,keywords:n,state:i,status:i?"unavailable"===i.state||"unknown"===i.state?i.state:"":Mt}}),o=s.filter(t=>""!==t.status).length;return W`
            ...
            <div class="rows">
              ${s.map(t=>W`
                  <div class="row">
                    ...
                    <span class="v">
                      ${t.status===Mt?e("ha.missing"):t.state?Et(t.state):""}
                    </span>
                  </div>
                `)}
            </div>
  ...
  `}function Nt(t,e){const n=t.filter?t.entries.filter(e=>e.direction===t.filter):t.entries;return W`
  ...
  `,t([mt({attribute:!1})],qt.prototype,"hass",void 0),t([mt()],qt.prototype,"value",void 0),t([mt()],qt.prototype,"placeholder",void 0),t([mt({attribute:!1})],qt.prototype,"domains",void 0),t([gt()],qt.prototype,"_query",void 0),t([gt()],qt.prototype,"_open",void 0),t([gt()],qt.prototype,"_active",void 0),qt=t([dt("hermes-entity-picker")],qt);const Ft=[{id:"turn_on",label:"Turn on",service:"homeassistant.turn_on"},{id:"turn_off",label:"Turn off",service:"homeassistant.turn_off"},{id:"toggle",label:"Toggle",service:"homeassistant.toggle"}];let Wt={light:[{id:"turn_on",label:"Turn on",service:"light.turn_on"},{id:"turn_on_brightness",label:"Turn on at brightness",service:"light.turn_on",value:{key:"brightness_pct",type:"number",unit:"%",min:1,max:100,step:1,default:80}},{id:"turn_off",label:"Turn off",service:"light.turn_off"},{id:"toggle",label:"Toggle",service:"light.toggle"}],switch:Ft,climate:[{id:"set_temperature",label:"Set temperature",service:"climate.set_temperature",value:{key:"temperature",type:"number",unit:"C",min:5,max:35,step:.5,default:21}},{id:"turn_on",label:"Turn on",service:"climate.turn_on"},{id:"turn_off",label:"Turn off",service:"climate.turn_off"}],cover:[{id:"open",label:"Open",service:"cover.open_cover"},{id:"close",label:"Close",service:"cover.close_cover"},{id:"stop",label:"Stop",service:"cover.stop_cover"},{id:"set_position",label:"Set position",service:"cover.set_cover_position",value:{key:"position",type:"number",unit:"%",min:0,max:100,step:5,default:100}}]},Ut={light:"light",switch:"switch",input_boolean:"switch",climate:"climate",cover:"cover"},Gt=Ft;const Kt={temperature:{min:"min_temp",max:"max_temp",step:"target_temp_step"},percentage:{step:"percentage_step"},value:{min:"min",max:"max",step:"step"}},Vt={hvac_mode:"hvac_modes",preset_mode:"preset_modes",fan_mode:"fan_modes",swing_mode:"swing_modes",operation_mode:"operation_list",source:"source_list"};function Yt(t,e,n){const i=t.states[e]?.attributes??{},s={...n},o=Kt[n.key]??{};for(const t of["min","max","step"]){const e=o[t],n=e?i[e]:void 0;"number"==typeof n&&(s[t]=n)}const a=Vt[n.key],r=a?i[a]:void 0;return Array.isArray(r)&&r.length&&(s.options=r.map(String),void 0!==s.default&&s.options.includes(String(s.default))||(s.default=s.options[0])),"number"==typeof s.default&&("number"==typeof s.min&&s.default<s.min&&(s.default=s.min),"number"==typeof s.max&&s.default>s.max&&(s.default=s.max)),s}const Jt=new Set(["friendly_name","icon","supported_features","device_class","entity_picture","attribution","supported_color_modes","hs_color","rgb_color","xy_color"]);function Xt(t,e,n){if("channel"!==e.mode)return n("messages.onDm");const i=e.channel_index??0,s=t.channels.find(t=>t.index===i);return s?`${i}: ${s.name}`:`${n("settings.channel")} ${i}`}function Qt(t,e){if(t.loadError)return W`
      <div class="empty">
    ...
    <div class="palette">
      ...
      ${n&&t.hass.states[n]?W`
            ...
            <div class="chips">
              ...
              ${function(t,e){const n=t.states[e];return n?.attributes?Object.entries(n.attributes).filter(([t,e])=>!Jt.has(t)&&("string"==typeof e||"number"==typeof e||"boolean"==typeof e)).map(([t])=>t).sort():[]}(t.hass,n).map(e=>W`
                  <button
                    class="chip read"
            ...
            <div class="chips">
              ${function(t){const e=Ut[function(t){return t.split(".")[0]??""}(t)];return e&&Wt[e]||Gt}(n).map(e=>W`
                  <span class="chip-group">
                    <button
                      class="chip do"
                      @click=${()=>t.onInsert(function(t,e,n){return t.value&&void 0!==n&&""!==n?`{do:${t.service}:${e}:${t.value.key}=${n}}`:`{do:${t.service}:${e}}`}(e,n,t.paletteValues[e.id]??(e.value?Yt(t.hass,n,e.value).default:void 0)))}
                    >
                      ${e.label}
                    </button>
                    ${function(t,e,n){if(!e.value)return"";const i=Yt(t.hass,n,e.value),s=t.paletteValues[e.id]??i.default??"";if("enum"===i.type)return W`
      <select
        class="inline"
  ...
  `}(t,t.editing,e):W`
          ${n.commands.length?n.commands.map(i=>function(t,e,n,i){const s=e.service||e.reply_template||"",o=e.reply_channel,a=null!=o?t.channels.find(t=>t.index===o):void 0,r="sender_dm"===e.reply_to?i("messages.onDm"):null!=o?`${o}${a?`: ${a.name}`:""}`:Xt(t,n,i);return W`
    <div class="list-row">
      <div class="meta">
  ...
  `}(t,n,e)}
        `}
  `}function te(t,e,n,i,s=null){if(s)return W`<div class="sub-error">${s}</div>`;if(!t.length)return W`<div class="hint">${i}</div>`;const o=new Set((e??[]).map(Number));return W`
    <div class="checklist">
      ${t.map(t=>W`
          <label class="check">
            <input
  ...
  `}function ee(t,e){const n=t.settings,i=e=>t.draftGlobal[e]??n?.[e];return W`
    <h2 class="screen-title">
      ${e("settings.title")}
      <button
        class="btn refresh"
    ...
    <div class="section">
      ...
      <div class="panel">
        ...
        <div class="field">
          ...
          ${te(t.nodes,i("map_nodes")??[],e=>t.onGlobalInput("map_nodes",e),e("settings.noNodes"),t.nodesError)}
  ...
  `}(t,e,n):""}
        ...
        <div class="field">
          ...
          ${te(t.nodes,s("authorized_nodes",e.authorized_nodes)??[],n=>t.onEntryInput(e.entry_id,"authorized_nodes",n),n("settings.noNodes"),t.nodesError)}
  ...
  `}(t,n,e))}
  `}const ne="0.24.0";function ie(t,e,n,i,s,o){if(!function(t){return kt(t,xt).length>0}(t))return W`<div class="empty">${o("status.noIntegration")}</div>`;const a=St(t),r=zt(t,"commands_executed"),l=zt(t,"last_command"),h=zt(t,"last_error"),c=t=>t&&"unknown"!==t&&"unavailable"!==t?t:o("status.none");return W`
    <h2 class="screen-title">
      ${o("status.title")}
    ...
    <div class="grid">
      ...
      <div class="panel stat">
        ...
        <div class="value small">${c(h?.state)}</div>
      </div>
    </div>
    ...
    <div class="section" style="margin-top:18px">
      ...
      <div class="panel">
        ...
        <div class="rows">
          ...
          ${t.backend_version&&t.backend_version!==ne?W`<div class="note warn">${n("status.versionMismatch")}</div>`:""}
          <div class="row">
  ...
  `}(t,n,o))}
  `}function se(t,e){return t.callWS({type:"hermes/settings/update",patch:e})}function oe(t){return t.callWS({type:"hermes/entries/list"})}function ae(t,e,n){return t.callWS({type:"hermes/entry/update",entry_id:e,patch:n})}function re(t){return t.callWS({type:"hermes/presets/list"})}function le(t){return t.callWS({type:"hermes/history/list"})}function he(t){return t.callWS({type:"hermes/chats/list"})}const ce=["status","chat","log","devices","map","messages","homeassistant","settings"],de={keyword:"",match_type:"exact",service:"",reply_template:"",reply_to:"channel"};let ue=class extends ht{constructor(){super(...arguments),this._tab="status",this._entries=[],this._nodes=[],this._settings=null,this._saved=!1,this._draftGlobal={},this._draftEntries={},this._selectedEntry=null,this._editing=null,this._loadError=null,this._paletteEntity="",this._paletteValues={},this._showAdvanced=!1,this._mapShowAll=!1,this._mapRadiusOn=!1,this._mapRadiusKm=25,this._presets=[],this._editingPreset=null,this._history=[],this._logFilter="",this._testText="",this._sendingTest=!1,this._channels=[],this._firmware=null,this._radio=null,this._nodesError=null,this._refreshing=!1,this._updatedAt="",this._chats={},this._chatThread=null,this._chatDraft="",this._chatSending=!1,this._loaded=!1,this._onGlobalInput=(t,e)=>{this._draftGlobal={...this._draftGlobal,[t]:e}},this._onEntryInput=(t,e,n)=>{this._draftEntries={...this._draftEntries,[t]:{...this._draftEntries[t]??{},[e]:n}}},this._onSaveGlobal=async()=>{this.hass&&Object.keys(this._draftGlobal).length&&(this._settings=await se(this.hass,this._draftGlobal),this._draftGlobal={},this._flagSaved())},this._onSaveEntry=async t=>{const e=this._draftEntries[t];this.hass&&e&&Object.keys(e).length&&(await ae(this.hass,t,e),this._draftEntries={...this._draftEntries,[t]:{}},this._flagSaved(),await this._load())},this._onSelectEntry=t=>{this._selectedEntry=t,this._editing=null},this._onNew=()=>{this._editing={...de}},this._onEdit=t=>{this._editing={...t}},this._onDuplicate=t=>{const{id:e,...n}=t;this._editing={...n,keyword:`${t.keyword} 2`}},this._onDraftInput=(t,e)=>{this._editing&&(this._editing={...this._editing,[t]:e})},this._onCancel=()=>{this._editing=null},this._onPaletteEntity=t=>{this._paletteEntity=t},this._onPaletteValue=(t,e)=>{this._paletteValues={...this._paletteValues,[t]:e}},this._onToggleAdvanced=()=>{this._showAdvanced=!this._showAdvanced},this._onPresetNew=()=>{this._editingPreset={label:"",text:"",node_id:null,channel:null}},this._onPresetEdit=t=>{this._editingPreset={...t}},this._onPresetInput=(t,e)=>{this._editingPreset&&(this._editingPreset={...this._editingPreset,[t]:e})},this._onPresetCancel=()=>{this._editingPreset=null},this._onPresetSave=async()=>{var t,e;this.hass&&this._editingPreset?.text&&(await(t=this.hass,e=this._editingPreset,t.callWS({type:"hermes/presets/save",preset:e})),this._editingPreset=null,this._presets=await re(this.hass),this._flagSaved())},this._onPresetDelete=async t=>{var e,n;this.hass&&t.id&&(await(e=this.hass,n=t.id,e.callWS({type:"hermes/presets/remove",preset_id:n})),this._presets=await re(this.hass))},this._onPresetSend=async t=>{const e=this._selectedEntry??this._entries[0]?.entry_id;this.hass&&e&&t.id&&(await function(t,e,n){return t.callWS({type:"hermes/presets/send",entry_id:e,preset_id:n})}(this.hass,e,t.id),this._flagSaved(),this._history=await le(this.hass))},this._onTestText=t=>{this._testText=t},this._onSendTest=async()=>{const t=this._selectedEntry??this._entries[0]?.entry_id;if(this.hass&&t&&this._testText){this._sendingTest=!0;try{await this.hass.callService("hermes","broadcast",{config_entry_id:t,message:this._testText}),this._flagSaved(),this._history=await le(this.hass)}catch(t){console.error("Hermes: test send failed",t)}finally{this._sendingTest=!1}}},this._onChatSelect=t=>{this._chatThread=t},this._onChatDraft=t=>{this._chatDraft=t},this._onChatSend=async()=>{const t=this._selectedEntry??this._entries[0]?.entry_id,e=this._chatThread??Object.keys(this._chats)[0];if(this.hass&&t&&e&&this._chatDraft.trim()){this._chatSending=!0;try{await function(t,e,n,i){return t.callWS({type:"hermes/chats/send",entry_id:e,thread:n,message:i})}(this.hass,t,e,this._chatDraft.trim()),this._chatDraft="",this._chats=await he(this.hass)}catch(t){console.error("Hermes: could not send the message",t)}finally{this._chatSending=!1}}},this._onChatClear=async t=>{this.hass&&(await function(t,e){return t.callWS({type:"hermes/chats/clear",thread:e})}(this.hass,t),this._chats=await he(this.hass))},this._onLogFilter=t=>{this._logFilter=t},this._onLogClear=async()=>{var t;this.hass&&(await(t=this.hass,t.callWS({type:"hermes/history/clear"})),this._history=[])},this._onToggleShowAll=()=>{this._mapShowAll=!this._mapShowAll},this._onToggleRadius=()=>{this._mapRadiusOn=!this._mapRadiusOn},this._onRadiusChange=t=>{this._mapRadiusKm=t},this._onApplySeen=async t=>{const e=t.last_seen;if(!this.hass||!e)return;const n={};null!==e.gateway&&(n.gateway_node_id=e.gateway),null!==e.channel&&void 0!==e.channel?(n.mode="channel",n.channel_index=e.channel):null!==e.node&&void 0!==e.node&&(n.mode="direct_message"),Object.keys(n).length&&(await ae(this.hass,t.entry_id,n),this._flagSaved(),await this._load())},this._onRefresh=async()=>{this._refreshing=!0;try{await this._load()}finally{this._refreshing=!1}},this._onHeightChange=async t=>{this.hass&&(this._settings=await se(this.hass,{map_height:t}))},this._onInsert=t=>{if(!this._editing)return;const e=this.renderRoot.querySelector("#hermes-template"),n=this._editing.reply_template??"";if(!e)return void(this._editing={...this._editing,reply_template:n+t});const i=e.selectionStart??n.length,s=e.selectionEnd??n.length,o=n.slice(0,i)+t+n.slice(s);this._editing={...this._editing,reply_template:o},this.updateComplete.then(()=>{const e=this.renderRoot.querySelector("#hermes-template");if(e){const n=i+t.length;e.focus(),e.setSelectionRange(n,n)}})},this._onSaveCommand=async()=>{const t=this._selectedEntry;if(!this.hass||!t||!this._editing)return;const e=Boolean(this._editing.service)||Boolean(this._editing.reply_template);this._editing.keyword&&e&&(await function(t,e,n){return t.callWS({type:"hermes/commands/save",entry_id:e,command:n})}(this.hass,t,this._editing),this._editing=null,this._flagSaved(),await this._load())},this._onDeleteCommand=async t=>{const e=this._selectedEntry;this.hass&&e&&t.id&&(await function(t,e,n){return t.callWS({type:"hermes/commands/remove",entry_id:e,command_id:n})}(this.hass,e,t.id),this._flagSaved(),await this._load())}}setConfig(t){this._config=t,t?.tab&&ce.includes(t.tab)&&(this._tab=t.tab)}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),this._subscribe(),this._pollTimer=window.setInterval(()=>{this._poll()},15e3)}disconnectedCallback(){super.disconnectedCallback(),this._pollTimer&&(window.clearInterval(this._pollTimer),this._pollTimer=void 0),this._unsubscribe&&(this._unsubscribe(),this._unsubscribe=void 0)}async _subscribe(){const t=this.hass?.connection;if(t?.subscribeEvents&&!this._unsubscribe)try{this._unsubscribe=await t.subscribeEvents(()=>{this._poll(!0)},"meshtastic_api_text_message")}catch(t){console.warn("Hermes: live updates unavailable, falling back to polling",t)}}async _poll(t=!1){if(this.hass&&this._loaded&&(t||"status"===this._tab||"log"===this._tab||"chat"===this._tab))try{this._entries=await oe(this.hass),this._history=await le(this.hass),this._chats=await he(this.hass),this._updatedAt=(new Date).toLocaleTimeString()}catch(t){console.warn("Hermes: refresh failed",t)}}firstUpdated(){let t=this.parentElement;for(;t;){if("HUI-PANEL-VIEW"===t.tagName){this.setAttribute("panel-mode","");break}t=t.parentElement}}updated(){this.hass&&!this._loaded&&(this._loaded=!0,this._load())}async _load(t=0){if(this.hass){try{const t=await oe(this.hass);this._entries=t,this._loadError=null,!this._selectedEntry&&t.length&&(this._selectedEntry=t[0].entry_id)}catch(e){if(t<3)return void window.setTimeout(()=>{this._load(t+1)},500*(t+1));this._loadError=String(e?.message??e),console.error("Hermes: failed to load gateways",e)}try{this._nodes=await(e=this.hass,e.callWS({type:"hermes/nodes/list"})),this._nodesError=null}catch(t){this._nodesError=String(t?.message??t),console.error("Hermes: failed to load nodes",t)}var e,n;try{this._channels=await function(t){return t.callWS({type:"hermes/channels/list"})}(this.hass)}catch(t){console.warn("Hermes: could not read the radio channels",t)}try{const t=await function(t){return t.callWS({type:"hermes/radio/info"})}(this.hass);this._radio=t,this._firmware=t.firmware}catch{this._firmware=null}try{n=await function(t){return t.callWS({type:"hermes/actions"})}(this.hass),n?.by_type&&(Wt=n.by_type),n?.domain_to_type&&(Ut=n.domain_to_type),n?.generic&&(Gt=n.generic)}catch(t){console.warn("Hermes: using the built-in action catalogue",t)}try{this._presets=await re(this.hass)}catch(t){console.error("Hermes: failed to load presets",t)}try{this._history=await le(this.hass)}catch(t){console.error("Hermes: failed to load the log",t)}try{this._chats=await he(this.hass)}catch(t){console.error("Hermes: failed to load the conversations",t)}try{this._settings=await function(t){return t.callWS({type:"hermes/settings/get"})}(this.hass)}catch{this._settings=null}}}_flagSaved(){this._saved=!0,window.setTimeout(()=>{this._saved=!1},2e3)}_select(t){this._tab=t,this._load()}_screen(t){const e=this.hass;switch(this._tab){case"status":default:return ie(e,this._entries,this._onApplySeen,this._updatedAt,this._radio,t);case"chat":return bt({chats:this._chats,channels:this._channels,nodes:this._nodes,thread:this._chatThread,draft:this._chatDraft,sending:this._chatSending,onSelect:this._onChatSelect,onDraft:this._onChatDraft,onSend:this._onChatSend,onClear:this._onChatClear},t);case"log":return Nt({entries:this._history,entries_meta:this._entries.map(t=>({title:t.title,counts:t.seen_counts??{}})),filter:this._logFilter,updatedAt:this._updatedAt,onFilter:this._onLogFilter,onClear:this._onLogClear,onRefresh:()=>{this._poll(!0)}},t);case"devices":return Ct(e,t);case"map":return jt({hass:e,settings:this._settings,authorized:[...new Set(this._entries.flatMap(t=>t.authorized_nodes??[]))],showAll:this._mapShowAll,radiusOn:this._mapRadiusOn,radiusKm:this._mapRadiusKm,onToggleShowAll:this._onToggleShowAll,onToggleRadius:this._onToggleRadius,onRadiusChange:this._onRadiusChange,onHeightChange:this._onHeightChange},t);case"messages":return Qt({hass:e,entries:this._entries,selectedEntry:this._selectedEntry,editing:this._editing,loadError:this._loadError,paletteEntity:this._paletteEntity,paletteValues:this._paletteValues,showAdvanced:this._showAdvanced,onSelectEntry:this._onSelectEntry,onNew:this._onNew,onEdit:this._onEdit,onDuplicate:this._onDuplicate,onDelete:this._onDeleteCommand,onDraftInput:this._onDraftInput,onPaletteEntity:this._onPaletteEntity,onPaletteValue:this._onPaletteValue,onInsert:this._onInsert,onToggleAdvanced:this._onToggleAdvanced,onSave:this._onSaveCommand,onCancel:this._onCancel,channels:this._channels,presets:this._presets,editingPreset:this._editingPreset,onPresetNew:this._onPresetNew,onPresetEdit:this._onPresetEdit,onPresetDelete:this._onPresetDelete,onPresetInput:this._onPresetInput,onPresetSave:this._onPresetSave,onPresetCancel:this._onPresetCancel,onPresetSend:this._onPresetSend},t);case"homeassistant":return Ht({hass:e,entries:this._entries,testText:this._testText,selectedEntry:this._selectedEntry,sending:this._sendingTest,onTestText:this._onTestText,onSendTest:this._onSendTest},t);case"settings":return ee({settings:this._settings,entries:this._entries,nodes:this._nodes,channels:this._channels,firmware:this._firmware,nodesError:this._nodesError,refreshing:this._refreshing,onRefresh:this._onRefresh,saved:this._saved,loadError:this._loadError,draftGlobal:this._draftGlobal,draftEntries:this._draftEntries,onGlobalInput:this._onGlobalInput,onEntryInput:this._onEntryInput,onSaveGlobal:this._onSaveGlobal,onSaveEntry:this._onSaveEntry},t)}}render(){if(!this.hass||!this._config)return W``;const t=function(t){const e=(t?.locale?.language||t?.language||"en").split("-")[0].toLowerCase(),n=_t[e]||ft;return t=>n[t]??ft[t]??t}(this.hass);return W`
      <div class="shell">
        <div class="topbar">
          <div class="brand">
            <span class="dot"></span>
    ...
    `}};ue.styles=[vt,yt],t([mt({attribute:!1})],ue.prototype,"hass",void 0),t([gt()],ue.prototype,"_config",void 0),t([gt()],ue.prototype,"_tab",void 0),t([gt()],ue.prototype,"_entries",void 0),t([gt()],ue.prototype,"_nodes",void 0),t([gt()],ue.prototype,"_settings",void 0),t([gt()],ue.prototype,"_saved",void 0),t([gt()],ue.prototype,"_draftGlobal",void 0),t([gt()],ue.prototype,"_draftEntries",void 0),t([gt()],ue.prototype,"_selectedEntry",void 0),t([gt()],ue.prototype,"_editing",void 0),t([gt()],ue.prototype,"_loadError",void 0),t([gt()],ue.prototype,"_paletteEntity",void 0),t([gt()],ue.prototype,"_paletteValues",void 0),t([gt()],ue.prototype,"_showAdvanced",void 0),t([gt()],ue.prototype,"_mapShowAll",void 0),t([gt()],ue.prototype,"_mapRadiusOn",void 0),t([gt()],ue.prototype,"_mapRadiusKm",void 0),t([gt()],ue.prototype,"_presets",void 0),t([gt()],ue.prototype,"_editingPreset",void 0),t([gt()],ue.prototype,"_history",void 0),t([gt()],ue.prototype,"_logFilter",void 0),t([gt()],ue.prototype,"_testText",void 0),t([gt()],ue.prototype,"_sendingTest",void 0),t([gt()],ue.prototype,"_channels",void 0),t([gt()],ue.prototype,"_firmware",void 0),t([gt()],ue.prototype,"_radio",void 0),t([gt()],ue.prototype,"_nodesError",void 0),t([gt()],ue.prototype,"_refreshing",void 0),t([gt()],ue.prototype,"_updatedAt",void 0),t([gt()],ue.prototype,"_chats",void 0),t([gt()],ue.prototype,"_chatThread",void 0),t([gt()],ue.prototype,"_chatDraft",void 0),t([gt()],ue.prototype,"_chatSending",void 0),ue=t([dt("hermes-card")],ue),window.customCards=window.customCards||[],window.customCards.push({type:"hermes-card",name:"Hermes",description:"Meshtastic Commander control panel",preview:!1}),console.info(`%c HERMES-CARD %c ${ne} `,"background:#FFD60A;color:#000","");export{ue as HermesCard};
