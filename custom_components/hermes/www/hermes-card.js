...
`,bt="meshtastic",xt="hermes";function wt(t,e){const i=t.entities;return i?Object.values(i).filter(t=>t.platform===e):Object.keys(t.states).filter(t=>t.includes(e)).map(t=>({entity_id:t,platform:e}))}function Pt(t,e){for(const i of wt(t,xt))if(i.entity_id.endsWith(e)){const e=t.states[i.entity_id];if(e)return e}}function Tt(t,e){const i=t.devices?.[e];if(!i?.identifiers)return null;for(const t of i.identifiers)if(t?.[0]===bt){const e=Number.parseInt(String(t[1]),10);return Number.isNaN(e)?null:e}return null}function kt(t){const e=(t.split(".")[1]??t).split("_");return e.slice(Math.max(e.length-2,0)).join(" ")}function Lt(t){const e=new Map;for(const i of wt(t,bt)){const n=i.device_id;if(!n)continue;const o=t.states[i.entity_id];if(!o)continue;let s=e.get(n);if(!s){const i=t.devices?.[n];s={deviceId:n,nodeNum:Tt(t,n),name:i?.name_by_user||i?.name||o.attributes?.friendly_name||n,values:{}},e.set(n,s)}s.values[kt(i.entity_id)]=o}return[...e.values()].sort((t,e)=>t.name.localeCompare(e.name))}const zt=72e5;function Et(t,e){if(!e)return!1;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return!1;const n=Date.parse(i.state);return!Number.isNaN(n)&&Date.now()-n<=zt}const St=[/\{state:([^:}]+)\}/g,/\{attr:([^:}]+):[^}]+\}/g,/\{do:[^:}]+:([^:}]+?)(?::[^}]*)?\}/g];function At(t){const e=t.attributes?.unit_of_measurement;return e?`${t.state} ${e}`:t.state}const Mt="missing";function $t(t,e){const i=function(t){const e=new Map,i=(t,i)=>{const n=t.trim();if(!n.includes("."))return;const o=e.get(n)??[];o.includes(i)||o.push(i),e.set(n,o)};for(const e of t)for(const t of e.commands??[]){const e=t.keyword||"?",n=t.target?.entity_id;"string"==typeof n&&i(n,e);const o=t.reply_template??"";for(const t of St){let n;for(t.lastIndex=0;null!==(n=t.exec(o));)i(n[1],e)}}return new Map([...e.entries()].sort((t,e)=>t[0].localeCompare(e[0])))}(t.entries),n=function(t){const e=[];for(const i of wt(t,xt)){const n=t.states[i.entity_id];n&&e.push(n)}return e.sort((t,e)=>t.entity_id.localeCompare(e.entity_id))}(t.hass),o=[...i.entries()].map(([e,i])=>{const n=t.hass.states[e];return{entityId:e,keywords:i,state:n,status:n?"unavailable"===n.state||"unknown"===n.state?n.state:"":Mt}}),s=o.filter(t=>""!==t.status).length;return U`
  ...
  `,t([mt({attribute:!1})],Rt.prototype,"hass",void 0),t([mt()],Rt.prototype,"value",void 0),t([mt()],Rt.prototype,"placeholder",void 0),t([mt({attribute:!1})],Rt.prototype,"domains",void 0),t([_t()],Rt.prototype,"_query",void 0),t([_t()],Rt.prototype,"_open",void 0),t([_t()],Rt.prototype,"_active",void 0),Rt=t([dt("hermes-entity-picker")],Rt);const Ht=[{id:"turn_on",label:"Turn on",service:"homeassistant.turn_on"},{id:"turn_off",label:"Turn off",service:"homeassistant.turn_off"},{id:"toggle",label:"Toggle",service:"homeassistant.toggle"}];let jt={light:[{id:"turn_on",label:"Turn on",service:"light.turn_on"},{id:"turn_on_brightness",label:"Turn on at brightness",service:"light.turn_on",value:{key:"brightness_pct",type:"number",unit:"%",min:1,max:100,step:1,default:80}},{id:"turn_off",label:"Turn off",service:"light.turn_off"},{id:"toggle",label:"Toggle",service:"light.toggle"}],switch:Ht,climate:[{id:"set_temperature",label:"Set temperature",service:"climate.set_temperature",value:{key:"temperature",type:"number",unit:"C",min:5,max:35,step:.5,default:21}},{id:"turn_on",label:"Turn on",service:"climate.turn_on"},{id:"turn_off",label:"Turn off",service:"climate.turn_off"}],cover:[{id:"open",label:"Open",service:"cover.open_cover"},{id:"close",label:"Close",service:"cover.close_cover"},{id:"stop",label:"Stop",service:"cover.stop_cover"},{id:"set_position",label:"Set position",service:"cover.set_cover_position",value:{key:"position",type:"number",unit:"%",min:0,max:100,step:5,default:100}}]},Ft={light:"light",switch:"switch",input_boolean:"switch",climate:"climate",cover:"cover"},Wt=Ht;const Ut={temperature:{min:"min_temp",max:"max_temp",step:"target_temp_step"},percentage:{step:"percentage_step"},value:{min:"min",max:"max",step:"step"}},Vt={hvac_mode:"hvac_modes",preset_mode:"preset_modes",fan_mode:"fan_modes",swing_mode:"swing_modes",operation_mode:"operation_list",source:"source_list"};function qt(t,e,i){const n=t.states[e]?.attributes??{},o={...i},s=Ut[i.key]??{};for(const t of["min","max","step"]){const e=s[t],i=e?n[e]:void 0;"number"==typeof i&&(o[t]=i)}const a=Vt[i.key],r=a?n[a]:void 0;return Array.isArray(r)&&r.length&&(o.options=r.map(String),void 0!==o.default&&o.options.includes(String(o.default))||(o.default=o.options[0])),"number"==typeof o.default&&("number"==typeof o.min&&o.default<o.min&&(o.default=o.min),"number"==typeof o.max&&o.default>o.max&&(o.default=o.max)),o}const Gt=new Set(["friendly_name","icon","supported_features","device_class","entity_picture","attribution","supported_color_modes","hs_color","rgb_color","xy_color"]);function Kt(t,e){if(t.loadError)return U`
      <div class="empty">
    ...
    <div class="palette">
      ...
      ${i&&t.hass.states[i]?U`
            ...
            <div class="chips">
              ...
              ${function(t,e){const i=t.states[e];return i?.attributes?Object.entries(i.attributes).filter(([t,e])=>!Gt.has(t)&&("string"==typeof e||"number"==typeof e||"boolean"==typeof e)).map(([t])=>t).sort():[]}(t.hass,i).map(e=>U`
                  <button
                    class="chip read"
            ...
            <div class="chips">
              ${function(t){const e=Ft[function(t){return t.split(".")[0]??""}(t)];return e&&jt[e]||Wt}(i).map(e=>U`
                  <span class="chip-group">
                    <button
                      class="chip do"
                      @click=${()=>t.onInsert(function(t,e,i){return t.value&&void 0!==i&&""!==i?`{do:${t.service}:${e}:${t.value.key}=${i}}`:`{do:${t.service}:${e}}`}(e,i,t.paletteValues[e.id]??(e.value?qt(t.hass,i,e.value).default:void 0)))}
                    >
                      ${e.label}
                    </button>
                    ${function(t,e,i){if(!e.value)return"";const n=qt(t.hass,i,e.value),o=t.paletteValues[e.id]??n.default??"";if("enum"===n.type)return U`
      <select
        class="inline"
  ...
  `}(t,i,e)}
        `}
  `}function Yt(t){return[...t.target.selectedOptions].map(t=>Number(t.value))}function Jt(t,e){return t.map(t=>U`
      ...
      <div class="panel">
        ...
        <div class="field">
          ...
          <select
            id="mapnodes"
            multiple
            @change=${e=>t.onGlobalInput("map_nodes",Yt(e))}
          >
            ${Jt(t.nodes,n("map_nodes")??[])}
          </select>
        </div>
    ...
    <div class="section">
      ...
      <div class="panel">
        ...
        <div class="field">
          ...
          <select
            multiple
            @change=${i=>t.onEntryInput(e.entry_id,"authorized_nodes",Yt(i))}
          >
            ${Jt(t.nodes,o("authorized_nodes",e.authorized_nodes)??[])}
          </select>
        </div>
  ...
  `}(t,i,e))}
  `}function Qt(t,e){if(!function(t){return wt(t,xt).length>0}(t))return U`<div class="empty">${e("status.noIntegration")}</div>`;const i=Lt(t),n=Pt(t,"commands_executed"),o=Pt(t,"last_command"),s=Pt(t,"last_error"),a=t=>t&&"unknown"!==t&&"unavailable"!==t?t:e("status.none");return U`
  ...
  `:U`<div class="empty">${e("devices.empty")}</div>`}(e,t);case"map":return Dt({hass:e,settings:this._settings,showAll:this._mapShowAll,radiusOn:this._mapRadiusOn,radiusKm:this._mapRadiusKm,onToggleShowAll:this._onToggleShowAll,onToggleRadius:this._onToggleRadius,onRadiusChange:this._onRadiusChange},t);case"messages":return Kt({hass:e,entries:this._entries,selectedEntry:this._selectedEntry,editing:this._editing,loadError:this._loadError,paletteEntity:this._paletteEntity,paletteValues:this._paletteValues,showAdvanced:this._showAdvanced,onSelectEntry:this._onSelectEntry,onNew:this._onNew,onEdit:this._onEdit,onDelete:this._onDeleteCommand,onDraftInput:this._onDraftInput,onPaletteEntity:this._onPaletteEntity,onPaletteValue:this._onPaletteValue,onInsert:this._onInsert,onToggleAdvanced:this._onToggleAdvanced,onSave:this._onSaveCommand,onCancel:this._onCancel,presets:this._presets,editingPreset:this._editingPreset,onPresetNew:this._onPresetNew,onPresetEdit:this._onPresetEdit,onPresetDelete:this._onPresetDelete,onPresetInput:this._onPresetInput,onPresetSave:this._onPresetSave,onPresetCancel:this._onPresetCancel,onPresetSend:this._onPresetSend},t);case"homeassistant":return $t({hass:e,entries:this._entries,testText:this._testText,selectedEntry:this._selectedEntry,sending:this._sendingTest,onTestText:this._onTestText,onSendTest:this._onSendTest},t);case"settings":return Xt({settings:this._settings,entries:this._entries,nodes:this._nodes,saved:this._saved,loadError:this._loadError,draftGlobal:this._draftGlobal,draftEntries:this._draftEntries,onGlobalInput:this._onGlobalInput,onEntryInput:this._onEntryInput,onSaveGlobal:this._onSaveGlobal,onSaveEntry:this._onSaveEntry},t)}}render(){if(!this.hass||!this._config)return U``;const t=function(t){const e=(t?.locale?.language||t?.language||"en").split("-")[0].toLowerCase(),i=gt[e]||ft;return t=>i[t]??ft[t]??t}(this.hass);return U`
    ...
    `}};oe.styles=[vt,yt],t([mt({attribute:!1})],oe.prototype,"hass",void 0),t([_t()],oe.prototype,"_config",void 0),t([_t()],oe.prototype,"_tab",void 0),t([_t()],oe.prototype,"_entries",void 0),t([_t()],oe.prototype,"_nodes",void 0),t([_t()],oe.prototype,"_settings",void 0),t([_t()],oe.prototype,"_saved",void 0),t([_t()],oe.prototype,"_draftGlobal",void 0),t([_t()],oe.prototype,"_draftEntries",void 0),t([_t()],oe.prototype,"_selectedEntry",void 0),t([_t()],oe.prototype,"_editing",void 0),t([_t()],oe.prototype,"_loadError",void 0),t([_t()],oe.prototype,"_paletteEntity",void 0),t([_t()],oe.prototype,"_paletteValues",void 0),t([_t()],oe.prototype,"_showAdvanced",void 0),t([_t()],oe.prototype,"_mapShowAll",void 0),t([_t()],oe.prototype,"_mapRadiusOn",void 0),t([_t()],oe.prototype,"_mapRadiusKm",void 0),t([_t()],oe.prototype,"_presets",void 0),t([_t()],oe.prototype,"_editingPreset",void 0),t([_t()],oe.prototype,"_history",void 0),t([_t()],oe.prototype,"_logFilter",void 0),t([_t()],oe.prototype,"_testText",void 0),t([_t()],oe.prototype,"_sendingTest",void 0),oe=t([dt("hermes-card")],oe),window.customCards=window.customCards||[],window.customCards.push({type:"hermes-card",name:"Hermes",description:"Meshtastic Commander control panel",preview:!1}),console.info("%c HERMES-CARD %c 0.7.0 ","background:#FFD60A;color:#000","");export{oe as HermesCard};
