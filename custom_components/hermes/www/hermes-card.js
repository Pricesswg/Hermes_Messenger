...
`,bt="meshtastic",wt="hermes";function xt(t,e){const n=t.entities;return n?Object.values(n).filter(t=>t.platform===e):Object.keys(t.states).filter(t=>t.includes(e)).map(t=>({entity_id:t,platform:e}))}function kt(t,e){for(const n of xt(t,wt))if(n.entity_id.endsWith(e)){const e=t.states[n.entity_id];if(e)return e}}function Pt(t,e){const n=t.devices?.[e];if(!n?.identifiers)return null;for(const t of n.identifiers)if(t?.[0]===bt){const e=Number.parseInt(String(t[1]),10);return Number.isNaN(e)?null:e}return null}function zt(t){const e=(t.split(".")[1]??t).split("_");return e.slice(Math.max(e.length-2,0)).join(" ")}function Lt(t){const e=new Map;for(const n of xt(t,bt)){const i=n.device_id;if(!i)continue;const s=t.states[n.entity_id];if(!s)continue;let o=e.get(i);if(!o){const n=t.devices?.[i];o={deviceId:i,nodeNum:Pt(t,i),name:n?.name_by_user||n?.name||s.attributes?.friendly_name||i,values:{}},e.set(i,o)}o.values[zt(n.entity_id)]=s}return[...e.values()].sort((t,e)=>t.name.localeCompare(e.name))}function Tt(t,e,n=120){if(!e)return!1;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return!1;const s=Date.parse(i.state);return!Number.isNaN(s)&&Date.now()-s<=60*n*1e3}const St=[/\{state:([^:}]+)\}/g,/\{attr:([^:}]+):[^}]+\}/g,/\{do:[^:}]+:([^:}]+?)(?::[^}]*)?\}/g];function Et(t){const e=t.attributes?.unit_of_measurement;return e?`${t.state} ${e}`:t.state}const At="missing";function $t(t,e){const n=function(t){const e=new Map,n=(t,n)=>{const i=t.trim();if(!i.includes("."))return;const s=e.get(i)??[];s.includes(n)||s.push(n),e.set(i,s)};for(const e of t)for(const t of e.commands??[]){const e=t.keyword||"?",i=t.target?.entity_id;"string"==typeof i&&n(i,e);const s=t.reply_template??"";for(const t of St){let i;for(t.lastIndex=0;null!==(i=t.exec(s));)n(i[1],e)}}return new Map([...e.entries()].sort((t,e)=>t[0].localeCompare(e[0])))}(t.entries),i=function(t){const e=[];for(const n of xt(t,wt)){const i=t.states[n.entity_id];i&&e.push(i)}return e.sort((t,e)=>t.entity_id.localeCompare(e.entity_id))}(t.hass),s=[...n.entries()].map(([e,n])=>{const i=t.hass.states[e];return{entityId:e,keywords:n,state:i,status:i?"unavailable"===i.state||"unknown"===i.state?i.state:"":At}}),o=s.filter(t=>""!==t.status).length;return W`
    ...
    <div class="palette">
      ...
      ${n&&t.hass.states[n]?W`
            ...
            <div class="chips">
              ...
              ${function(t,e){const n=t.states[e];return n?.attributes?Object.entries(n.attributes).filter(([t,e])=>!Gt.has(t)&&("string"==typeof e||"number"==typeof e||"boolean"==typeof e)).map(([t])=>t).sort():[]}(t.hass,n).map(e=>W`
                  <button
                    class="chip read"
            ...
            <div class="chips">
              ${function(t){const e=qt[function(t){return t.split(".")[0]??""}(t)];return e&&jt[e]||Ft}(n).map(e=>W`
  ...
  `}(t,n)}
      ...
      ${s?W`<div class="note">${n("messages.dmGatewayNote")}</div>`:""}

      ${"channel"!==e.reply_to||s?"":W`
  ...
  `}(t,t.editing,e):W`
          ${n.commands.length?n.commands.map(i=>function(t,e,n,i){const s=e.service||e.reply_template||"",o=e.reply_channel,a=null!=o?t.channels.find(t=>t.index===o):void 0,r="sender_dm"===e.reply_to?i("messages.onDm"):null!=o?`${o}${a?`: ${a.name}`:""}`:Vt(t,n,i);return W`
    <div class="list-row">
      <div class="meta">
  ...
  `}(t,n,e))}
  `}function Qt(t,e){if(!function(t){return xt(t,wt).length>0}(t))return W`<div class="empty">${e("status.noIntegration")}</div>`;const n=Lt(t),i=kt(t,"commands_executed"),s=kt(t,"last_command"),o=kt(t,"last_error"),a=t=>t&&"unknown"!==t&&"unavailable"!==t?t:e("status.none");return W`
  ...
  `:W`<div class="empty">${e("devices.empty")}</div>`}(e,t);case"map":return Zt({hass:e,settings:this._settings,showAll:this._mapShowAll,radiusOn:this._mapRadiusOn,radiusKm:this._mapRadiusKm,onToggleShowAll:this._onToggleShowAll,onToggleRadius:this._onToggleRadius,onRadiusChange:this._onRadiusChange,onHeightChange:this._onHeightChange},t);case"messages":return Yt({hass:e,entries:this._entries,selectedEntry:this._selectedEntry,editing:this._editing,loadError:this._loadError,paletteEntity:this._paletteEntity,paletteValues:this._paletteValues,showAdvanced:this._showAdvanced,onSelectEntry:this._onSelectEntry,onNew:this._onNew,onEdit:this._onEdit,onDelete:this._onDeleteCommand,onDraftInput:this._onDraftInput,onPaletteEntity:this._onPaletteEntity,onPaletteValue:this._onPaletteValue,onInsert:this._onInsert,onToggleAdvanced:this._onToggleAdvanced,onSave:this._onSaveCommand,onCancel:this._onCancel,channels:this._channels,presets:this._presets,editingPreset:this._editingPreset,onPresetNew:this._onPresetNew,onPresetEdit:this._onPresetEdit,onPresetDelete:this._onPresetDelete,onPresetInput:this._onPresetInput,onPresetSave:this._onPresetSave,onPresetCancel:this._onPresetCancel,onPresetSend:this._onPresetSend},t);case"homeassistant":return $t({hass:e,entries:this._entries,testText:this._testText,selectedEntry:this._selectedEntry,sending:this._sendingTest,onTestText:this._onTestText,onSendTest:this._onSendTest},t);case"settings":return Xt({settings:this._settings,entries:this._entries,nodes:this._nodes,channels:this._channels,firmware:this._firmware,nodesError:this._nodesError,refreshing:this._refreshing,onRefresh:this._onRefresh,saved:this._saved,loadError:this._loadError,draftGlobal:this._draftGlobal,draftEntries:this._draftEntries,onGlobalInput:this._onGlobalInput,onEntryInput:this._onEntryInput,onSaveGlobal:this._onSaveGlobal,onSaveEntry:this._onSaveEntry},t)}}render(){if(!this.hass||!this._config)return W``;const t=function(t){const e=(t?.locale?.language||t?.language||"en").split("-")[0].toLowerCase(),n=_t[e]||ft;return t=>n[t]??ft[t]??t}(this.hass);return W`
    ...
    `}};oe.styles=[vt,yt],t([mt({attribute:!1})],oe.prototype,"hass",void 0),t([gt()],oe.prototype,"_config",void 0),t([gt()],oe.prototype,"_tab",void 0),t([gt()],oe.prototype,"_entries",void 0),t([gt()],oe.prototype,"_nodes",void 0),t([gt()],oe.prototype,"_settings",void 0),t([gt()],oe.prototype,"_saved",void 0),t([gt()],oe.prototype,"_draftGlobal",void 0),t([gt()],oe.prototype,"_draftEntries",void 0),t([gt()],oe.prototype,"_selectedEntry",void 0),t([gt()],oe.prototype,"_editing",void 0),t([gt()],oe.prototype,"_loadError",void 0),t([gt()],oe.prototype,"_paletteEntity",void 0),t([gt()],oe.prototype,"_paletteValues",void 0),t([gt()],oe.prototype,"_showAdvanced",void 0),t([gt()],oe.prototype,"_mapShowAll",void 0),t([gt()],oe.prototype,"_mapRadiusOn",void 0),t([gt()],oe.prototype,"_mapRadiusKm",void 0),t([gt()],oe.prototype,"_presets",void 0),t([gt()],oe.prototype,"_editingPreset",void 0),t([gt()],oe.prototype,"_history",void 0),t([gt()],oe.prototype,"_logFilter",void 0),t([gt()],oe.prototype,"_testText",void 0),t([gt()],oe.prototype,"_sendingTest",void 0),t([gt()],oe.prototype,"_channels",void 0),t([gt()],oe.prototype,"_firmware",void 0),t([gt()],oe.prototype,"_nodesError",void 0),t([gt()],oe.prototype,"_refreshing",void 0),oe=t([dt("hermes-card")],oe),window.customCards=window.customCards||[],window.customCards.push({type:"hermes-card",name:"Hermes",description:"Meshtastic Commander control panel",preview:!1}),console.info("%c HERMES-CARD %c 0.13.0 ","background:#FFD60A;color:#000","");export{oe as HermesCard};
