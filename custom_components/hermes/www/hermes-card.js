...
`,bt="meshtastic",xt="hermes";function wt(t,e){const i=t.entities;return i?Object.values(i).filter(t=>t.platform===e):Object.keys(t.states).filter(t=>t.includes(e)).map(t=>({entity_id:t,platform:e}))}function Pt(t,e){for(const i of wt(t,xt))if(i.entity_id.endsWith(e)){const e=t.states[i.entity_id];if(e)return e}}function kt(t,e){const i=t.devices?.[e];if(!i?.identifiers)return null;for(const t of i.identifiers)if(t?.[0]===bt){const e=Number.parseInt(String(t[1]),10);return Number.isNaN(e)?null:e}return null}function zt(t){const e=(t.split(".")[1]??t).split("_");return e.slice(Math.max(e.length-2,0)).join(" ")}function Tt(t){const e=new Map;for(const i of wt(t,bt)){const n=i.device_id;if(!n)continue;const o=t.states[i.entity_id];if(!o)continue;let s=e.get(n);if(!s){const i=t.devices?.[n];s={deviceId:n,nodeNum:kt(t,n),name:i?.name_by_user||i?.name||o.attributes?.friendly_name||n,values:{}},e.set(n,s)}s.values[zt(i.entity_id)]=o}return[...e.values()].sort((t,e)=>t.name.localeCompare(e.name))}const Lt=72e5;function Et(t,e){if(!e)return!1;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return!1;const n=Date.parse(i.state);return!Number.isNaN(n)&&Date.now()-n<=Lt}const St=[/\{state:([^:}]+)\}/g,/\{attr:([^:}]+):[^}]+\}/g,/\{do:[^:}]+:([^:}]+?)(?::[^}]*)?\}/g];function At(t){const e=t.attributes?.unit_of_measurement;return e?`${t.state} ${e}`:t.state}const Mt="missing";function $t(t,e){const i=function(t){const e=new Map,i=(t,i)=>{const n=t.trim();if(!n.includes("."))return;const o=e.get(n)??[];o.includes(i)||o.push(i),e.set(n,o)};for(const e of t)for(const t of e.commands??[]){const e=t.keyword||"?",n=t.target?.entity_id;"string"==typeof n&&i(n,e);const o=t.reply_template??"";for(const t of St){let n;for(t.lastIndex=0;null!==(n=t.exec(o));)i(n[1],e)}}return new Map([...e.entries()].sort((t,e)=>t[0].localeCompare(e[0])))}(t.entries),n=function(t){const e=[];for(const i of wt(t,xt)){const n=t.states[i.entity_id];n&&e.push(n)}return e.sort((t,e)=>t.entity_id.localeCompare(e.entity_id))}(t.hass),o=[...i.entries()].map(([e,i])=>{const n=t.hass.states[e];return{entityId:e,keywords:i,state:n,status:n?"unavailable"===n.state||"unknown"===n.state?n.state:"":Mt}}),s=o.filter(t=>""!==t.status).length;return U`
    ...
    <div class="section">
      <div class="section-title">
        ${e("ha.connected")}
        ${s?U`<span class="warn-badge">${s} ${e("ha.problems")}</span>`:""}
      </div>
      ${o.length?U`
            <div class="rows">
              ${o.map(t=>U`
                  <div class="row">
                    ...
                    <span class="v">
                      ${t.status===Mt?e("ha.missing"):t.state?At(t.state):""}
                    </span>
                  </div>
                `)}
            </div>
  ...
  `}function Ct(t,e){const i=t.filter?t.entries.filter(e=>e.direction===t.filter):t.entries;return U`
    ...
    <div class="palette">
      ...
      ${i&&t.hass.states[i]?U`
            ...
            <div class="chips">
              ...
              ${function(t,e){const i=t.states[e];return i?.attributes?Object.entries(i.attributes).filter(([t,e])=>!Kt.has(t)&&("string"==typeof e||"number"==typeof e||"boolean"==typeof e)).map(([t])=>t).sort():[]}(t.hass,i).map(e=>U`
                  <button
                    class="chip read"
            ...
            <div class="chips">
              ${function(t){const e=Wt[function(t){return t.split(".")[0]??""}(t)];return e&&Ft[e]||Ut}(i).map(e=>U`
                  <span class="chip-group">
                    <button
                      class="chip do"
                      @click=${()=>t.onInsert(function(t,e,i){return t.value&&void 0!==i&&""!==i?`{do:${t.service}:${e}:${t.value.key}=${i}}`:`{do:${t.service}:${e}}`}(e,i,t.paletteValues[e.id]??(e.value?Gt(t.hass,i,e.value).default:void 0)))}
                    >
                      ${e.label}
                    </button>
                    ${function(t,e,i){if(!e.value)return"";const n=Gt(t.hass,i,e.value),o=t.paletteValues[e.id]??n.default??"";if("enum"===n.type)return U`
      <select
        class="inline"
  ...
  `}(t,i,e)}
        `}
  `}function Jt(t,e,i,n){if(!t.length)return U`<div class="hint">${n}</div>`;const o=new Set((e??[]).map(Number));return U`
    <div class="checklist">
      ${t.map(t=>U`
          <label class="check">
            <input
  ...
  `}function Xt(t,e){const i=t.settings,n=e=>t.draftGlobal[e]??i?.[e];return U`
    ...
    <div class="section">
      ...
      <div class="panel">
        ...
        <div class="field">
          ...
          ${Jt(t.nodes,n("map_nodes")??[],e=>t.onGlobalInput("map_nodes",e),e("settings.noNodes"))}
    ...
    <div class="section">
      ...
      <div class="panel">
        ...
        <div class="field">
          ...
          ${Jt(t.nodes,o("authorized_nodes",e.authorized_nodes)??[],i=>t.onEntryInput(e.entry_id,"authorized_nodes",i),i("settings.noNodes"))}
  ...
  `}(t,i,e))}
  `}function Qt(t,e){if(!function(t){return wt(t,xt).length>0}(t))return U`<div class="empty">${e("status.noIntegration")}</div>`;const i=Tt(t),n=Pt(t,"commands_executed"),o=Pt(t,"last_command"),s=Pt(t,"last_error"),a=t=>t&&"unknown"!==t&&"unavailable"!==t?t:e("status.none");return U`
  ...
  `:U`<div class="empty">${e("devices.empty")}</div>`}(e,t);case"map":return Dt({hass:e,settings:this._settings,showAll:this._mapShowAll,radiusOn:this._mapRadiusOn,radiusKm:this._mapRadiusKm,onToggleShowAll:this._onToggleShowAll,onToggleRadius:this._onToggleRadius,onRadiusChange:this._onRadiusChange,onHeightChange:this._onHeightChange},t);case"messages":return Yt({hass:e,entries:this._entries,selectedEntry:this._selectedEntry,editing:this._editing,loadError:this._loadError,paletteEntity:this._paletteEntity,paletteValues:this._paletteValues,showAdvanced:this._showAdvanced,onSelectEntry:this._onSelectEntry,onNew:this._onNew,onEdit:this._onEdit,onDelete:this._onDeleteCommand,onDraftInput:this._onDraftInput,onPaletteEntity:this._onPaletteEntity,onPaletteValue:this._onPaletteValue,onInsert:this._onInsert,onToggleAdvanced:this._onToggleAdvanced,onSave:this._onSaveCommand,onCancel:this._onCancel,presets:this._presets,editingPreset:this._editingPreset,onPresetNew:this._onPresetNew,onPresetEdit:this._onPresetEdit,onPresetDelete:this._onPresetDelete,onPresetInput:this._onPresetInput,onPresetSave:this._onPresetSave,onPresetCancel:this._onPresetCancel,onPresetSend:this._onPresetSend},t);case"homeassistant":return $t({hass:e,entries:this._entries,testText:this._testText,selectedEntry:this._selectedEntry,sending:this._sendingTest,onTestText:this._onTestText,onSendTest:this._onSendTest},t);case"settings":return Xt({settings:this._settings,entries:this._entries,nodes:this._nodes,saved:this._saved,loadError:this._loadError,draftGlobal:this._draftGlobal,draftEntries:this._draftEntries,onGlobalInput:this._onGlobalInput,onEntryInput:this._onEntryInput,onSaveGlobal:this._onSaveGlobal,onSaveEntry:this._onSaveEntry},t)}}render(){if(!this.hass||!this._config)return U``;const t=function(t){const e=(t?.locale?.language||t?.language||"en").split("-")[0].toLowerCase(),i=gt[e]||ft;return t=>i[t]??ft[t]??t}(this.hass);return U`
    ...
    `}};se.styles=[vt,yt],t([mt({attribute:!1})],se.prototype,"hass",void 0),t([_t()],se.prototype,"_config",void 0),t([_t()],se.prototype,"_tab",void 0),t([_t()],se.prototype,"_entries",void 0),t([_t()],se.prototype,"_nodes",void 0),t([_t()],se.prototype,"_settings",void 0),t([_t()],se.prototype,"_saved",void 0),t([_t()],se.prototype,"_draftGlobal",void 0),t([_t()],se.prototype,"_draftEntries",void 0),t([_t()],se.prototype,"_selectedEntry",void 0),t([_t()],se.prototype,"_editing",void 0),t([_t()],se.prototype,"_loadError",void 0),t([_t()],se.prototype,"_paletteEntity",void 0),t([_t()],se.prototype,"_paletteValues",void 0),t([_t()],se.prototype,"_showAdvanced",void 0),t([_t()],se.prototype,"_mapShowAll",void 0),t([_t()],se.prototype,"_mapRadiusOn",void 0),t([_t()],se.prototype,"_mapRadiusKm",void 0),t([_t()],se.prototype,"_presets",void 0),t([_t()],se.prototype,"_editingPreset",void 0),t([_t()],se.prototype,"_history",void 0),t([_t()],se.prototype,"_logFilter",void 0),t([_t()],se.prototype,"_testText",void 0),t([_t()],se.prototype,"_sendingTest",void 0),se=t([dt("hermes-card")],se),window.customCards=window.customCards||[],window.customCards.push({type:"hermes-card",name:"Hermes",description:"Meshtastic Commander control panel",preview:!1}),console.info("%c HERMES-CARD %c 0.7.1 ","background:#FFD60A;color:#000","");export{se as HermesCard};
