...
`;function be(e,t){const n=e.chats[t];return n?.length?n[n.length-1].ts:""}function we(e,t,n){const i=Number(e.split(":")[1]),s=t.channels.find(e=>e.index===i);return s?`${i}: ${s.name}`:`${n("settings.channel")} ${i}`}function xe(e,t){const n=e.split(":")[1],i=t.nodes.find(e=>String(e.node_num)===n);return i?i.name:n}function ke(e,t,n,i){const s=e.chats[t]?.length??0;return F`
  ...
  `}(e,e.editing,t):F`
    ...
    ${i.map((o,r)=>{const l=(o.group??"").trim(),c=s&&l!==a?F`<div class="section-title group-head">
            ...
            </div>`:"";return a=l,F`${c}${function(e,t,n,i,s=0,a=1,o=!1){const r=t.service||t.reply_template||"",l=t.reply_channel,c=null!=l?e.channels.find(e=>e.index===l):void 0,d="sender_dm"===t.reply_to?i("messages.onDm"):null!=l?`${l}${c?`: ${c.name}`:""}`:rt(e,n,i);return F`
  ...
  `}(e,n,t))}
  `}const mt="1.3.2";function gt(e,t,n,i,s){if(!Te(e))return F`<div class="empty">${s("status.noIntegration")}</div>`;const a=Ee(e),o=Le(e,"commands_executed",t),r=Le(e,"last_command",t),l=Le(e,"last_error",t),c=e=>e&&"unknown"!==e&&"unavailable"!==e?e:s("status.none");return F`
    <h2 class="screen-title">
      ${s("status.title")}
