...
`,bt="meshtastic",wt="hermes";function xt(t,e){const n=t.entities;return n?Object.values(n).filter(t=>t.platform===e):Object.keys(t.states).filter(t=>t.includes(e)).map(t=>({entity_id:t,platform:e}))}function kt(t,e){for(const n of xt(t,wt))if(n.entity_id.endsWith(e)){const e=t.states[n.entity_id];if(e)return e}}function Pt(t,e){const n=t.devices?.[e];if(!n?.identifiers)return null;for(const t of n.identifiers)if(t?.[0]===bt){const e=Number.parseInt(String(t[1]),10);return Number.isNaN(e)?null:e}return null}function zt(t){const e=(t.split(".")[1]??t).split("_");return e.slice(Math.max(e.length-2,0)).join(" ")}function Lt(t){const e=new Map;for(const n of xt(t,bt)){const i=n.device_id;if(!i)continue;const s=t.states[n.entity_id];if(!s)continue;let o=e.get(i);if(!o){const n=t.devices?.[i];o={deviceId:i,nodeNum:Pt(t,i),name:n?.name_by_user||n?.name||s.attributes?.friendly_name||i,values:{}},e.set(i,o)}o.values[zt(n.entity_id)]=s}return[...e.values()].sort((t,e)=>t.name.localeCompare(e.name))}function Tt(t,e,n=120){if(!e)return!1;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return!1;const s=Date.parse(i.state);return!Number.isNaN(s)&&Date.now()-s<=60*n*1e3}const $t=[/\{state:([^:}]+)\}/g,/\{attr:([^:}]+):[^}]+\}/g,/\{do:[^:}]+:([^:}]+?)(?::[^}]*)?\}/g];function St(t){const e=t.attributes?.unit_of_measurement;return e?`${t.state} ${e}`:t.state}const At="missing";function Et(t,e){const n=function(t){const e=new Map,n=(t,n)=>{const i=t.trim();if(!i.includes("."))return;const s=e.get(i)??[];s.includes(n)||s.push(n),e.set(i,s)};for(const e of t)for(const t of e.commands??[]){const e=t.keyword||"?",i=t.target?.entity_id;"string"==typeof i&&n(i,e);const s=t.reply_template??"";for(const t of $t){let i;for(t.lastIndex=0;null!==(i=t.exec(s));)n(i[1],e)}}return new Map([...e.entries()].sort((t,e)=>t[0].localeCompare(e[0])))}(t.entries),i=function(t){const e=[];for(const n of xt(t,wt)){const i=t.states[n.entity_id];i&&e.push(i)}return e.sort((t,e)=>t.entity_id.localeCompare(e.entity_id))}(t.hass),s=[...n.entries()].map(([e,n])=>{const i=t.hass.states[e];return{entityId:e,keywords:n,state:i,status:i?"unavailable"===i.state||"unknown"===i.state?i.state:"":At}}),o=s.filter(t=>""!==t.status).length;return W`
  ...
  `}(t,t.editing,e):W`
          ${n.commands.length?n.commands.map(i=>function(t,e,n,i){const s=e.service||e.reply_template||"",o=e.reply_channel,a=null!=o?t.channels.find(t=>t.index===o):void 0,r="sender_dm"===e.reply_to?i("messages.onDm"):null!=o?`${o}${a?`: ${a.name}`:""}`:Kt(t,n,i);return W`
    <div class="list-row">
      <div class="meta">
    ...
    <div class="section" style="margin-top:18px">
      ...
      <div class="panel">
        ...
        <div class="rows">
          ...
          ${t.backend_version&&t.backend_version!==Qt?W`<div class="note warn">${n("status.versionMismatch")}</div>`:""}
          <div class="row">
  ...
  `}(t,n,s))}
  `}function ee(t,e){return t.callWS({type:"hermes/settings/update",patch:e})}function ne(t){return t.callWS({type:"hermes/entries/list"})}function ie(t,e,n){return t.callWS({type:"hermes/entry/update",entry_id:e,patch:n})}function se(t){return t.callWS({type:"hermes/presets/list"})}function oe(t){return t.callWS({type:"hermes/history/list"})}const ae=["status","log","devices","map","messages","homeassistant","settings"],re={keyword:"",match_type:"exact",service:"",reply_template:"",reply_to:"channel"};let le=class extends ht{constructor(){super(...arguments),this._tab="status",this._entries=[],this._nodes=[],this._settings=null,this._saved=!1,this._draftGlobal={},this._draftEntries={},this._selectedEntry=null,this._editing=null,this._loadError=null,this._paletteEntity="",this._paletteValues={},this._showAdvanced=!1,this._mapShowAll=!1,this._mapRadiusOn=!1,this._mapRadiusKm=25,this._presets=[],this._editingPreset=null,this._history=[],this._logFilter="",this._testText="",this._sendingTest=!1,this._channels=[],this._firmware=null,this._nodesError=null,this._refreshing=!1,this._updatedAt="",this._loaded=!1,this._onGlobalInput=(t,e)=>{this._draftGlobal={...this._draftGlobal,[t]:e}},this._onEntryInput=(t,e,n)=>{this._draftEntries={...this._draftEntries,[t]:{...this._draftEntries[t]??{},[e]:n}}},this._onSaveGlobal=async()=>{this.hass&&Object.keys(this._draftGlobal).length&&(this._settings=await ee(this.hass,this._draftGlobal),this._draftGlobal={},this._flagSaved())},this._onSaveEntry=async t=>{const e=this._draftEntries[t];this.hass&&e&&Object.keys(e).length&&(await ie(this.hass,t,e),this._draftEntries={...this._draftEntries,[t]:{}},this._flagSaved(),await this._load())},this._onSelectEntry=t=>{this._selectedEntry=t,this._editing=null},this._onNew=()=>{this._editing={...re}},this._onEdit=t=>{this._editing={...t}},this._onDraftInput=(t,e)=>{this._editing&&(this._editing={...this._editing,[t]:e})},this._onCancel=()=>{this._editing=null},this._onPaletteEntity=t=>{this._paletteEntity=t},this._onPaletteValue=(t,e)=>{this._paletteValues={...this._paletteValues,[t]:e}},this._onToggleAdvanced=()=>{this._showAdvanced=!this._showAdvanced},this._onPresetNew=()=>{this._editingPreset={label:"",text:"",node_id:null,channel:null}},this._onPresetEdit=t=>{this._editingPreset={...t}},this._onPresetInput=(t,e)=>{this._editingPreset&&(this._editingPreset={...this._editingPreset,[t]:e})},this._onPresetCancel=()=>{this._editingPreset=null},this._onPresetSave=async()=>{var t,e;this.hass&&this._editingPreset?.text&&(await(t=this.hass,e=this._editingPreset,t.callWS({type:"hermes/presets/save",preset:e})),this._editingPreset=null,this._presets=await se(this.hass),this._flagSaved())},this._onPresetDelete=async t=>{var e,n;this.hass&&t.id&&(await(e=this.hass,n=t.id,e.callWS({type:"hermes/presets/remove",preset_id:n})),this._presets=await se(this.hass))},this._onPresetSend=async t=>{const e=this._selectedEntry??this._entries[0]?.entry_id;this.hass&&e&&t.id&&(await function(t,e,n){return t.callWS({type:"hermes/presets/send",entry_id:e,preset_id:n})}(this.hass,e,t.id),this._flagSaved(),this._history=await oe(this.hass))},this._onTestText=t=>{this._testText=t},this._onSendTest=async()=>{const t=this._selectedEntry??this._entries[0]?.entry_id;if(this.hass&&t&&this._testText){this._sendingTest=!0;try{await this.hass.callService("hermes","broadcast",{config_entry_id:t,message:this._testText}),this._flagSaved(),this._history=await oe(this.hass)}catch(t){console.error("Hermes: test send failed",t)}finally{this._sendingTest=!1}}},this._onLogFilter=t=>{this._logFilter=t},this._onLogClear=async()=>{var t;this.hass&&(await(t=this.hass,t.callWS({type:"hermes/history/clear"})),this._history=[])},this._onToggleShowAll=()=>{this._mapShowAll=!this._mapShowAll},this._onToggleRadius=()=>{this._mapRadiusOn=!this._mapRadiusOn},this._onRadiusChange=t=>{this._mapRadiusKm=t},this._onApplySeen=async t=>{const e=t.last_seen;if(!this.hass||!e)return;const n={};null!==e.gateway&&(n.gateway_node_id=e.gateway),null!==e.channel&&void 0!==e.channel?(n.mode="channel",n.channel_index=e.channel):null!==e.node&&void 0!==e.node&&(n.mode="direct_message"),Object.keys(n).length&&(await ie(this.hass,t.entry_id,n),this._flagSaved(),await this._load())},this._onRefresh=async()=>{this._refreshing=!0;try{await this._load()}finally{this._refreshing=!1}},this._onHeightChange=async t=>{this.hass&&(this._settings=await ee(this.hass,{map_height:t}))},this._onInsert=t=>{if(!this._editing)return;const e=this.renderRoot.querySelector("#hermes-template"),n=this._editing.reply_template??"";if(!e)return void(this._editing={...this._editing,reply_template:n+t});const i=e.selectionStart??n.length,s=e.selectionEnd??n.length,o=n.slice(0,i)+t+n.slice(s);this._editing={...this._editing,reply_template:o},this.updateComplete.then(()=>{const e=this.renderRoot.querySelector("#hermes-template");if(e){const n=i+t.length;e.focus(),e.setSelectionRange(n,n)}})},this._onSaveCommand=async()=>{const t=this._selectedEntry;if(!this.hass||!t||!this._editing)return;const e=Boolean(this._editing.service)||Boolean(this._editing.reply_template);this._editing.keyword&&e&&(await function(t,e,n){return t.callWS({type:"hermes/commands/save",entry_id:e,command:n})}(this.hass,t,this._editing),this._editing=null,this._flagSaved(),await this._load())},this._onDeleteCommand=async t=>{const e=this._selectedEntry;this.hass&&e&&t.id&&(await function(t,e,n){return t.callWS({type:"hermes/commands/remove",entry_id:e,command_id:n})}(this.hass,e,t.id),this._flagSaved(),await this._load())}}setConfig(t){this._config=t,t?.tab&&ae.includes(t.tab)&&(this._tab=t.tab)}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),this._subscribe(),this._pollTimer=window.setInterval(()=>{this._poll()},15e3)}disconnectedCallback(){super.disconnectedCallback(),this._pollTimer&&(window.clearInterval(this._pollTimer),this._pollTimer=void 0),this._unsubscribe&&(this._unsubscribe(),this._unsubscribe=void 0)}async _subscribe(){const t=this.hass?.connection;if(t?.subscribeEvents&&!this._unsubscribe)try{this._unsubscribe=await t.subscribeEvents(()=>{this._poll(!0)},"meshtastic_api_text_message")}catch(t){console.warn("Hermes: live updates unavailable, falling back to polling",t)}}async _poll(t=!1){if(this.hass&&this._loaded&&(t||"status"===this._tab||"log"===this._tab))try{this._entries=await ne(this.hass),this._history=await oe(this.hass),this._updatedAt=(new Date).toLocaleTimeString()}catch(t){console.warn("Hermes: refresh failed",t)}}firstUpdated(){let t=this.parentElement;for(;t;){if("HUI-PANEL-VIEW"===t.tagName){this.setAttribute("panel-mode","");break}t=t.parentElement}}updated(){this.hass&&!this._loaded&&(this._loaded=!0,this._load())}async _load(t=0){if(this.hass){try{const t=await ne(this.hass);this._entries=t,this._loadError=null,!this._selectedEntry&&t.length&&(this._selectedEntry=t[0].entry_id)}catch(e){if(t<3)return void window.setTimeout(()=>{this._load(t+1)},500*(t+1));this._loadError=String(e?.message??e),console.error("Hermes: failed to load gateways",e)}try{this._nodes=await(e=this.hass,e.callWS({type:"hermes/nodes/list"})),this._nodesError=null}catch(t){this._nodesError=String(t?.message??t),console.error("Hermes: failed to load nodes",t)}var e,n;try{this._channels=await function(t){return t.callWS({type:"hermes/channels/list"})}(this.hass)}catch(t){console.warn("Hermes: could not read the radio channels",t)}try{this._firmware=(await function(t){return t.callWS({type:"hermes/radio/info"})}(this.hass)).firmware}catch{this._firmware=null}try{n=await function(t){return t.callWS({type:"hermes/actions"})}(this.hass),n?.by_type&&(jt=n.by_type),n?.domain_to_type&&(qt=n.domain_to_type),n?.generic&&(Ft=n.generic)}catch(t){console.warn("Hermes: using the built-in action catalogue",t)}try{this._presets=await se(this.hass)}catch(t){console.error("Hermes: failed to load presets",t)}try{this._history=await oe(this.hass)}catch(t){console.error("Hermes: failed to load the log",t)}try{this._settings=await function(t){return t.callWS({type:"hermes/settings/get"})}(this.hass)}catch{this._settings=null}}}_flagSaved(){this._saved=!0,window.setTimeout(()=>{this._saved=!1},2e3)}_select(t){this._tab=t,this._load()}_screen(t){const e=this.hass;switch(this._tab){case"status":default:return te(e,this._entries,this._onApplySeen,this._updatedAt,t);case"log":return Mt({entries:this._history,entries_meta:this._entries.map(t=>({title:t.title,counts:t.seen_counts??{}})),filter:this._logFilter,updatedAt:this._updatedAt,onFilter:this._onLogFilter,onClear:this._onLogClear,onRefresh:()=>{this._poll(!0)}},t);case"devices":return function(t,e){const n=Lt(t);return n.length?W`
  ...
  `:W`<div class="empty">${e("devices.empty")}</div>`}(e,t);case"map":return Bt({hass:e,settings:this._settings,showAll:this._mapShowAll,radiusOn:this._mapRadiusOn,radiusKm:this._mapRadiusKm,onToggleShowAll:this._onToggleShowAll,onToggleRadius:this._onToggleRadius,onRadiusChange:this._onRadiusChange,onHeightChange:this._onHeightChange},t);case"messages":return Yt({hass:e,entries:this._entries,selectedEntry:this._selectedEntry,editing:this._editing,loadError:this._loadError,paletteEntity:this._paletteEntity,paletteValues:this._paletteValues,showAdvanced:this._showAdvanced,onSelectEntry:this._onSelectEntry,onNew:this._onNew,onEdit:this._onEdit,onDelete:this._onDeleteCommand,onDraftInput:this._onDraftInput,onPaletteEntity:this._onPaletteEntity,onPaletteValue:this._onPaletteValue,onInsert:this._onInsert,onToggleAdvanced:this._onToggleAdvanced,onSave:this._onSaveCommand,onCancel:this._onCancel,channels:this._channels,presets:this._presets,editingPreset:this._editingPreset,onPresetNew:this._onPresetNew,onPresetEdit:this._onPresetEdit,onPresetDelete:this._onPresetDelete,onPresetInput:this._onPresetInput,onPresetSave:this._onPresetSave,onPresetCancel:this._onPresetCancel,onPresetSend:this._onPresetSend},t);case"homeassistant":return Et({hass:e,entries:this._entries,testText:this._testText,selectedEntry:this._selectedEntry,sending:this._sendingTest,onTestText:this._onTestText,onSendTest:this._onSendTest},t);case"settings":return Xt({settings:this._settings,entries:this._entries,nodes:this._nodes,channels:this._channels,firmware:this._firmware,nodesError:this._nodesError,refreshing:this._refreshing,onRefresh:this._onRefresh,saved:this._saved,loadError:this._loadError,draftGlobal:this._draftGlobal,draftEntries:this._draftEntries,onGlobalInput:this._onGlobalInput,onEntryInput:this._onEntryInput,onSaveGlobal:this._onSaveGlobal,onSaveEntry:this._onSaveEntry},t)}}render(){if(!this.hass||!this._config)return W``;const t=function(t){const e=(t?.locale?.language||t?.language||"en").split("-")[0].toLowerCase(),n=_t[e]||ft;return t=>n[t]??ft[t]??t}(this.hass);return W`
    ...
    `}};le.styles=[vt,yt],t([mt({attribute:!1})],le.prototype,"hass",void 0),t([gt()],le.prototype,"_config",void 0),t([gt()],le.prototype,"_tab",void 0),t([gt()],le.prototype,"_entries",void 0),t([gt()],le.prototype,"_nodes",void 0),t([gt()],le.prototype,"_settings",void 0),t([gt()],le.prototype,"_saved",void 0),t([gt()],le.prototype,"_draftGlobal",void 0),t([gt()],le.prototype,"_draftEntries",void 0),t([gt()],le.prototype,"_selectedEntry",void 0),t([gt()],le.prototype,"_editing",void 0),t([gt()],le.prototype,"_loadError",void 0),t([gt()],le.prototype,"_paletteEntity",void 0),t([gt()],le.prototype,"_paletteValues",void 0),t([gt()],le.prototype,"_showAdvanced",void 0),t([gt()],le.prototype,"_mapShowAll",void 0),t([gt()],le.prototype,"_mapRadiusOn",void 0),t([gt()],le.prototype,"_mapRadiusKm",void 0),t([gt()],le.prototype,"_presets",void 0),t([gt()],le.prototype,"_editingPreset",void 0),t([gt()],le.prototype,"_history",void 0),t([gt()],le.prototype,"_logFilter",void 0),t([gt()],le.prototype,"_testText",void 0),t([gt()],le.prototype,"_sendingTest",void 0),t([gt()],le.prototype,"_channels",void 0),t([gt()],le.prototype,"_firmware",void 0),t([gt()],le.prototype,"_nodesError",void 0),t([gt()],le.prototype,"_refreshing",void 0),t([gt()],le.prototype,"_updatedAt",void 0),le=t([dt("hermes-card")],le),window.customCards=window.customCards||[],window.customCards.push({type:"hermes-card",name:"Hermes",description:"Meshtastic Commander control panel",preview:!1}),console.info(`%c HERMES-CARD %c ${Qt} `,"background:#FFD60A;color:#000","");export{le as HermesCard};
