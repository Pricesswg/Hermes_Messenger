            ...
            <div class="rows">
              ${s.map(t=>W`
                  <div class="row">
                    ...
                    <span class="v">
                      ${t.status===At?e("ha.missing"):t.state?$t(t.state):""}
                    </span>
                  </div>
                `)}
            </div>
