...
`,bt="meshtastic",xt="hermes";function wt(t,e){const n=t.entities;return n?Object.values(n).filter(t=>t.platform===e):Object.keys(t.states).filter(t=>t.includes(e)).map(t=>({entity_id:t,platform:e}))}function kt(t,e){for(const n of wt(t,xt))if(n.entity_id.endsWith(e)){const e=t.states[n.entity_id];if(e)return e}}function Pt(t,e){const n=t.devices?.[e];if(!n?.identifiers)return null;for(const t of n.identifiers)if(t?.[0]===bt){const e=Number.parseInt(String(t[1]),10);return Number.isNaN(e)?null:e}return null}function zt(t){const e=(t.split(".")[1]??t).split("_");return e.slice(Math.max(e.length-2,0)).join(" ")}function Lt(t){const e=new Map;for(const n of wt(t,bt)){const i=n.device_id;if(!i)continue;const s=t.states[n.entity_id];if(!s)continue;let o=e.get(i);if(!o){const n=t.devices?.[i];o={deviceId:i,nodeNum:Pt(t,i),name:n?.name_by_user||n?.name||s.attributes?.friendly_name||i,values:{}},e.set(i,o)}o.values[zt(n.entity_id)]=s}return[...e.values()].sort((t,e)=>t.name.localeCompare(e.name))}function Tt(t,e,n=120){if(!e)return!1;const i=t.states[e];if(!i||"unavailable"===i.state||"unknown"===i.state)return!1;const s=Date.parse(i.state);return!Number.isNaN(s)&&Date.now()-s<=60*n*1e3}const St=[/\{state:([^:}]+)\}/g,/\{attr:([^:}]+):[^}]+\}/g,/\{do:[^:}]+:([^:}]+?)(?::[^}]*)?\}/g];function Et(t){const e=t.attributes?.unit_of_measurement;return e?`${t.state} ${e}`:t.state}const At="missing";function $t(t,e){const n=function(t){const e=new Map,n=(t,n)=>{const i=t.trim();if(!i.includes("."))return;const s=e.get(i)??[];s.includes(n)||s.push(n),e.set(i,s)};for(const e of t)for(const t of e.commands??[]){const e=t.keyword||"?",i=t.target?.entity_id;"string"==typeof i&&n(i,e);const s=t.reply_template??"";for(const t of St){let i;for(t.lastIndex=0;null!==(i=t.exec(s));)n(i[1],e)}}return new Map([...e.entries()].sort((t,e)=>t[0].localeCompare(e[0])))}(t.entries),i=function(t){const e=[];for(const n of wt(t,xt)){const i=t.states[n.entity_id];i&&e.push(i)}return e.sort((t,e)=>t.entity_id.localeCompare(e.entity_id))}(t.hass),s=[...n.entries()].map(([e,n])=>{const i=t.hass.states[e];return{entityId:e,keywords:n,state:i,status:i?"unavailable"===i.state||"unknown"===i.state?i.state:"":At}}),o=s.filter(t=>""!==t.status).length;return W`
    ...
    <div class="palette">
      ...
      ${n&&t.hass.states[n]?W`
            ...
            <div class="chips">
              ...
              ${function(t,e){const n=t.states[e];return n?.attributes?Object.entries(n.attributes).filter(([t,e])=>!Vt.has(t)&&("string"==typeof e||"number"==typeof e||"boolean"==typeof e)).map(([t])=>t).sort():[]}(t.hass,n).map(e=>W`
                  <button
                    class="chip read"
            ...
            <div class="chips">
              ${function(t){const e=Ft[function(t){return t.split(".")[0]??""}(t)];return e&&jt[e]||qt}(n).map(e=>W`
                  <span class="chip-group">
                    <button
                      class="chip do"
                      @click=${()=>t.onInsert(function(t,e,n){return t.value&&void 0!==n&&""!==n?`{do:${t.service}:${e}:${t.value.key}=${n}}`:`{do:${t.service}:${e}}`}(e,n,t.paletteValues[e.id]??(e.value?Kt(t.hass,n,e.value).default:void 0)))}
                    >
                      ${e.label}
                    </button>
                    ${function(t,e,n){if(!e.value)return"";const i=Kt(t.hass,n,e.value),s=t.paletteValues[e.id]??i.default??"";if("enum"===i.type)return W`
      <select
        class="inline"
  ...
  `}(t,n)}
      ...
      ${"channel"===e.reply_to?W`
            <div class="field indented">
              ...
              <span class="hint">${n("messages.replyChannelHint")}</span>
            </div>
          `:""}
  ...
  `}(t,t.editing,e):W`
          ${n.commands.length?n.commands.map(i=>function(t,e,n,i){const s=e.service||e.reply_template||"",o=e.reply_channel,a=null!=o?t.channels.find(t=>t.index===o):void 0,r="sender_dm"===e.reply_to?i("messages.onDm"):null!=o?`${o}${a?`: ${a.name}`:""}`:Gt(t,n,i);return W`
    <div class="list-row">
      <div class="meta">
  ...
  `}(t,n,e))}
  `}function Qt(t,e){if(!function(t){return wt(t,xt).length>0}(t))return W`<div class="empty">${e("status.noIntegration")}</div>`;const n=Lt(t),i=kt(t,"commands_executed"),s=kt(t,"last_command"),o=kt(t,"last_error"),a=t=>t&&"unknown"!==t&&"unavailable"!==t?t:e("status.none");return W`
  ...
  `:W`<div class="empty">${e("devices.empty")}</div>`}(e,t);case"map":return Zt({hass:e,settings:this._settings,showAll:this._mapShowAll,radiusOn:this._mapRadiusOn,radiusKm:this._mapRadiusKm,onToggleShowAll:this._onToggleShowAll,onToggleRadius:this._onToggleRadius,onRadiusChange:this._onRadiusChange,onHeightChange:this._onHeightChange},t);case"messages":return Yt({hass:e,entries:this._entries,selectedEntry:this._selectedEntry,editing:this._editing,loadError:this._loadError,paletteEntity:this._paletteEntity,paletteValues:this._paletteValues,showAdvanced:this._showAdvanced,onSelectEntry:this._onSelectEntry,onNew:this._onNew,onEdit:this._onEdit,onDelete:this._onDeleteCommand,onDraftInput:this._onDraftInput,onPaletteEntity:this._onPaletteEntity,onPaletteValue:this._onPaletteValue,onInsert:this._onInsert,onToggleAdvanced:this._onToggleAdvanced,onSave:this._onSaveCommand,onCancel:this._onCancel,channels:this._channels,presets:this._presets,editingPreset:this._editingPreset,onPresetNew:this._onPresetNew,onPresetEdit:this._onPresetEdit,onPresetDelete:this._onPresetDelete,onPresetInput:this._onPresetInput,onPresetSave:this._onPresetSave,onPresetCancel:this._onPresetCancel,onPresetSend:this._onPresetSend},t);case"homeassistant":return $t({hass:e,entries:this._entries,testText:this._testText,selectedEntry:this._selectedEntry,sending:this._sendingTest,onTestText:this._onTestText,onSendTest:this._onSendTest},t);case"settings":return Xt({settings:this._settings,entries:this._entries,nodes:this._nodes,channels:this._channels,firmware:this._firmware,nodesError:this._nodesError,refreshing:this._refreshing,onRefresh:this._onRefresh,onChannelChange:this._onChannelChange,saved:this._saved,loadError:this._loadError,draftGlobal:this._draftGlobal,draftEntries:this._draftEntries,onGlobalInput:this._onGlobalInput,onEntryInput:this._onEntryInput,onSaveGlobal:this._onSaveGlobal,onSaveEntry:this._onSaveEntry},t)}}render(){if(!this.hass||!this._config)return W``;const t=function(t){const e=(t?.locale?.language||t?.language||"en").split("-")[0].toLowerCase(),n=_t[e]||ft;return t=>n[t]??ft[t]??t}(this.hass);return W`
    ...
    `}};ae.styles=[vt,yt],t([mt({attribute:!1})],ae.prototype,"hass",void 0),t([gt()],ae.prototype,"_config",void 0),t([gt()],ae.prototype,"_tab",void 0),t([gt()],ae.prototype,"_entries",void 0),t([gt()],ae.prototype,"_nodes",void 0),t([gt()],ae.prototype,"_settings",void 0),t([gt()],ae.prototype,"_saved",void 0),t([gt()],ae.prototype,"_draftGlobal",void 0),t([gt()],ae.prototype,"_draftEntries",void 0),t([gt()],ae.prototype,"_selectedEntry",void 0),t([gt()],ae.prototype,"_editing",void 0),t([gt()],ae.prototype,"_loadError",void 0),t([gt()],ae.prototype,"_paletteEntity",void 0),t([gt()],ae.prototype,"_paletteValues",void 0),t([gt()],ae.prototype,"_showAdvanced",void 0),t([gt()],ae.prototype,"_mapShowAll",void 0),t([gt()],ae.prototype,"_mapRadiusOn",void 0),t([gt()],ae.prototype,"_mapRadiusKm",void 0),t([gt()],ae.prototype,"_presets",void 0),t([gt()],ae.prototype,"_editingPreset",void 0),t([gt()],ae.prototype,"_history",void 0),t([gt()],ae.prototype,"_logFilter",void 0),t([gt()],ae.prototype,"_testText",void 0),t([gt()],ae.prototype,"_sendingTest",void 0),t([gt()],ae.prototype,"_channels",void 0),t([gt()],ae.prototype,"_firmware",void 0),t([gt()],ae.prototype,"_nodesError",void 0),t([gt()],ae.prototype,"_refreshing",void 0),ae=t([dt("hermes-card")],ae),window.customCards=window.customCards||[],window.customCards.push({type:"hermes-card",name:"Hermes",description:"Meshtastic Commander control panel",preview:!1}),console.info("%c HERMES-CARD %c 0.12.0 ","background:#FFD60A;color:#000","");export{ae as HermesCard};
