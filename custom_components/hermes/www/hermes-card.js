...
`,fe="meshtastic",ye="hermes";function be(e,t){const s=e.entities;return s?Object.values(s).filter(e=>e.platform===t):Object.keys(e.states).filter(e=>e.includes(t)).map(e=>({entity_id:e,platform:t}))}function _e(e,t){for(const s of be(e,ye))if(s.entity_id.endsWith(t)){const t=e.states[s.entity_id];if(t)return t}}function $e(e,t){const s=e.devices?.[t];if(!s?.identifiers)return null;for(const e of s.identifiers)if(e?.[0]===fe){const t=Number.parseInt(String(e[1]),10);return Number.isNaN(t)?null:t}return null}function we(e){const t=(e.split(".")[1]??e).split("_");return t.slice(Math.max(t.length-2,0)).join(" ")}function xe(e){const t=new Map;for(const s of be(e,fe)){const a=s.device_id;if(!a)continue;const i=e.states[s.entity_id];if(!i)continue;let n=t.get(a);if(!n){const s=e.devices?.[a];n={deviceId:a,nodeNum:$e(e,a),name:s?.name_by_user||s?.name||i.attributes?.friendly_name||a,values:{}},t.set(a,n)}n.values[we(s.entity_id)]=i}return[...t.values()].sort((e,t)=>e.name.localeCompare(t.name))}const Ee=[{id:"turn_on",label:"Turn on",service:"homeassistant.turn_on"},{id:"turn_off",label:"Turn off",service:"homeassistant.turn_off"},{id:"toggle",label:"Toggle",service:"homeassistant.toggle"}];let Ae={light:[{id:"turn_on",label:"Turn on",service:"light.turn_on"},{id:"turn_on_brightness",label:"Turn on at brightness",service:"light.turn_on",value:{key:"brightness_pct",type:"number",unit:"%",min:1,max:100,step:1,default:80}},{id:"turn_off",label:"Turn off",service:"light.turn_off"},{id:"toggle",label:"Toggle",service:"light.toggle"}],switch:Ee,climate:[{id:"set_temperature",label:"Set temperature",service:"climate.set_temperature",value:{key:"temperature",type:"number",unit:"C",min:5,max:35,step:.5,default:21}},{id:"turn_on",label:"Turn on",service:"climate.turn_on"},{id:"turn_off",label:"Turn off",service:"climate.turn_off"}],cover:[{id:"open",label:"Open",service:"cover.open_cover"},{id:"close",label:"Close",service:"cover.close_cover"},{id:"stop",label:"Stop",service:"cover.stop_cover"},{id:"set_position",label:"Set position",service:"cover.set_cover_position",value:{key:"position",type:"number",unit:"%",min:0,max:100,step:5,default:100}}]},ke={light:"light",switch:"switch",input_boolean:"switch",climate:"climate",cover:"cover"},Se=Ee;const Ce=new Set(["friendly_name","icon","supported_features","device_class","entity_picture","attribution","supported_color_modes","hs_color","rgb_color","xy_color"]);function He(e,t){if(e.loadError)return W`
    ...
    <div class="palette">
      ...
      ${s&&e.hass.states[s]?W`
            ...
            <div class="chips">
              ...
              ${function(e,t){const s=e.states[t];return s?.attributes?Object.entries(s.attributes).filter(([e,t])=>!Ce.has(e)&&("string"==typeof t||"number"==typeof t||"boolean"==typeof t)).map(([e])=>e).sort():[]}(e.hass,s).map(t=>W`
                  <button
                    class="chip read"
            ...
            <div class="chips">
              ${function(e){const t=ke[function(e){return e.split(".")[0]??""}(e)];return t&&Ae[t]||Se}(s).map(t=>W`
                  <span class="chip-group">
                    <button
                      class="chip do"
                      @click=${()=>e.onInsert(function(e,t,s){return e.value&&void 0!==s&&""!==s?`{do:${e.service}:${t}:${e.value.key}=${s}}`:`{do:${e.service}:${t}}`}(t,s,e.paletteValues[t.id]??t.value?.default))}
                    >
                      ${t.label}
                    </button>
                    ${function(e,t){const s=t.value;if(!s)return"";const a=e.paletteValues[t.id]??s.default??"";if("enum"===s.type)return W`
      <select
        class="inline"
    ...
    />
    ${s.unit?W`<span class="unit">${s.unit}</span>`:""}
  `}(e,t)}
                  </span>
                `)}
            </div>
  ...
  `}(e,s,t)):W`<div class="empty">${t("messages.empty")}</div>`}
        ...
        `}
  `}function ze(e,t,s){return W`
    <h2 class="screen-title">${e}</h2>
    <div class="empty">
      <div class="badge">${s("common.phase")} ${t}</div>
      <p>${s("common.comingSoon")}</p>
    </div>
  `}function Ne(e){return[...e.target.selectedOptions].map(e=>Number(e.value))}function Me(e,t){return e.map(e=>W`
      <option value=${e.node_num} ?selected=${t.includes(e.node_num)}>
        ${e.name} (${e.node_num})
      </option>
    `)}function De(e,t){const s=e.settings,a=t=>e.draftGlobal[t]??s?.[t];return W`
      ...
      <div class="panel">
        ...
        <div class="field">
          ...
          <select
            id="mapnodes"
            multiple
            @change=${t=>e.onGlobalInput("map_nodes",Ne(t))}
          >
            ${Me(e.nodes,a("map_nodes")??[])}
          </select>
        </div>
    ...
    ${e.loadError?W`<div class="empty">
          <div>${t("common.loadError")}</div>
          <div class="sub-error">${e.loadError}</div>
        </div>`:0===e.entries.length?W`<div class="empty">${t("common.noEntries")}</div>`:e.entries.map(s=>function(e,t,s){const a=e.draftEntries[t.entry_id]??{},i=(e,t)=>a[e]??t;return W`
    <div class="section">
      ...
      <div class="panel">
        ...
        <div class="field" style="margin-top:12px">
          ...
          <input
            ...
            max="60"
            step="1"
            .value=${String(i("initial_delay",t.initial_delay))}
        ...
        <div class="field">
          ...
          <input
            ...
            max="30"
            step="1"
            .value=${String(i("part_delay",t.part_delay))}
        ...
        <div class="field">
          ...
          <select
            multiple
            @change=${s=>e.onEntryInput(t.entry_id,"authorized_nodes",Ne(s))}
          >
            ${Me(e.nodes,i("authorized_nodes",t.authorized_nodes)??[])}
          </select>
        </div>
  ...
  `}(e,s,t))}
  `}function Pe(e,t){if(!function(e){return be(e,ye).length>0}(e))return W`<div class="empty">${t("status.noIntegration")}</div>`;const s=xe(e),a=_e(e,"commands_executed"),i=_e(e,"last_command"),n=_e(e,"last_error"),o=e=>e&&"unknown"!==e&&"unavailable"!==e?e:t("status.none");return W`
  ...
  `}const Te=["status","devices","map","messages","homeassistant","settings"],Ie={keyword:"",match_type:"exact",service:"",reply_template:"",reply_to:"channel"};let Oe=class extends re{constructor(){super(...arguments),this._tab="status",this._entries=[],this._nodes=[],this._settings=null,this._saved=!1,this._draftGlobal={},this._draftEntries={},this._selectedEntry=null,this._editing=null,this._loadError=null,this._paletteEntity="",this._paletteValues={},this._showAdvanced=!1,this._loaded=!1,this._onGlobalInput=(e,t)=>{this._draftGlobal={...this._draftGlobal,[e]:t}},this._onEntryInput=(e,t,s)=>{this._draftEntries={...this._draftEntries,[e]:{...this._draftEntries[e]??{},[t]:s}}},this._onSaveGlobal=async()=>{var e,t;this.hass&&Object.keys(this._draftGlobal).length&&(this._settings=await(e=this.hass,t=this._draftGlobal,e.callWS({type:"hermes/settings/update",patch:t})),this._draftGlobal={},this._flagSaved())},this._onSaveEntry=async e=>{const t=this._draftEntries[e];this.hass&&t&&Object.keys(t).length&&(await function(e,t,s){return e.callWS({type:"hermes/entry/update",entry_id:t,patch:s})}(this.hass,e,t),this._draftEntries={...this._draftEntries,[e]:{}},this._flagSaved(),await this._load())},this._onSelectEntry=e=>{this._selectedEntry=e,this._editing=null},this._onNew=()=>{this._editing={...Ie}},this._onEdit=e=>{this._editing={...e}},this._onDraftInput=(e,t)=>{this._editing&&(this._editing={...this._editing,[e]:t})},this._onCancel=()=>{this._editing=null},this._onPaletteEntity=e=>{this._paletteEntity=e},this._onPaletteValue=(e,t)=>{this._paletteValues={...this._paletteValues,[e]:t}},this._onToggleAdvanced=()=>{this._showAdvanced=!this._showAdvanced},this._onInsert=e=>{if(!this._editing)return;const t=this.renderRoot.querySelector("#hermes-template"),s=this._editing.reply_template??"";if(!t)return void(this._editing={...this._editing,reply_template:s+e});const a=t.selectionStart??s.length,i=t.selectionEnd??s.length,n=s.slice(0,a)+e+s.slice(i);this._editing={...this._editing,reply_template:n},this.updateComplete.then(()=>{const t=this.renderRoot.querySelector("#hermes-template");if(t){const s=a+e.length;t.focus(),t.setSelectionRange(s,s)}})},this._onSaveCommand=async()=>{const e=this._selectedEntry;if(!this.hass||!e||!this._editing)return;const t=Boolean(this._editing.service)||Boolean(this._editing.reply_template);this._editing.keyword&&t&&(await function(e,t,s){return e.callWS({type:"hermes/commands/save",entry_id:t,command:s})}(this.hass,e,this._editing),this._editing=null,this._flagSaved(),await this._load())},this._onDeleteCommand=async e=>{const t=this._selectedEntry;this.hass&&t&&e.id&&(await function(e,t,s){return e.callWS({type:"hermes/commands/remove",entry_id:t,command_id:s})}(this.hass,t,e.id),this._flagSaved(),await this._load())}}setConfig(e){this._config=e,e?.tab&&Te.includes(e.tab)&&(this._tab=e.tab)}getCardSize(){return 12}firstUpdated(){let e=this.parentElement;for(;e;){if("HUI-PANEL-VIEW"===e.tagName){this.setAttribute("panel-mode","");break}e=e.parentElement}}updated(){this.hass&&!this._loaded&&(this._loaded=!0,this._load())}async _load(e=0){if(this.hass){try{const e=await(t=this.hass,t.callWS({type:"hermes/entries/list"}));this._entries=e,this._loadError=null,!this._selectedEntry&&e.length&&(this._selectedEntry=e[0].entry_id)}catch(t){if(e<3)return void window.setTimeout(()=>{this._load(e+1)},500*(e+1));this._loadError=String(t?.message??t),console.error("Hermes: failed to load gateways",t)}var t,s;try{this._nodes=await function(e){return e.callWS({type:"hermes/nodes/list"})}(this.hass)}catch(e){console.error("Hermes: failed to load nodes",e)}try{s=await function(e){return e.callWS({type:"hermes/actions"})}(this.hass),s?.by_type&&(Ae=s.by_type),s?.domain_to_type&&(ke=s.domain_to_type),s?.generic&&(Se=s.generic)}catch(e){console.warn("Hermes: using the built-in action catalogue",e)}try{this._settings=await function(e){return e.callWS({type:"hermes/settings/get"})}(this.hass)}catch{this._settings=null}}}_flagSaved(){this._saved=!0,window.setTimeout(()=>{this._saved=!1},2e3)}_select(e){this._tab=e}_screen(e){const t=this.hass;switch(this._tab){case"status":default:return Pe(t,e);case"devices":return function(e,t){const s=xe(e);return s.length?W`
  ...
  `:W`<div class="empty">${t("devices.empty")}</div>`}(t,e);case"map":return ze(e("tab.map"),3,e);case"messages":return He({hass:t,entries:this._entries,selectedEntry:this._selectedEntry,editing:this._editing,loadError:this._loadError,entityIds:Object.keys(t.states).sort(),paletteEntity:this._paletteEntity,paletteValues:this._paletteValues,showAdvanced:this._showAdvanced,onSelectEntry:this._onSelectEntry,onNew:this._onNew,onEdit:this._onEdit,onDelete:this._onDeleteCommand,onDraftInput:this._onDraftInput,onPaletteEntity:this._onPaletteEntity,onPaletteValue:this._onPaletteValue,onInsert:this._onInsert,onToggleAdvanced:this._onToggleAdvanced,onSave:this._onSaveCommand,onCancel:this._onCancel},e);case"homeassistant":return ze(e("tab.homeassistant"),4,e);case"settings":return De({settings:this._settings,entries:this._entries,nodes:this._nodes,saved:this._saved,loadError:this._loadError,draftGlobal:this._draftGlobal,draftEntries:this._draftEntries,onGlobalInput:this._onGlobalInput,onEntryInput:this._onEntryInput,onSaveGlobal:this._onSaveGlobal,onSaveEntry:this._onSaveEntry},e)}}render(){if(!this.hass||!this._config)return W``;const e=function(e){const t=(e?.locale?.language||e?.language||"en").split("-")[0].toLowerCase(),s=ue[t]||he;return e=>s[e]??he[e]??e}(this.hass);return W`
    ...
    `}};Oe.styles=[ge,ve],e([pe({attribute:!1})],Oe.prototype,"hass",void 0),e([me()],Oe.prototype,"_config",void 0),e([me()],Oe.prototype,"_tab",void 0),e([me()],Oe.prototype,"_entries",void 0),e([me()],Oe.prototype,"_nodes",void 0),e([me()],Oe.prototype,"_settings",void 0),e([me()],Oe.prototype,"_saved",void 0),e([me()],Oe.prototype,"_draftGlobal",void 0),e([me()],Oe.prototype,"_draftEntries",void 0),e([me()],Oe.prototype,"_selectedEntry",void 0),e([me()],Oe.prototype,"_editing",void 0),e([me()],Oe.prototype,"_loadError",void 0),e([me()],Oe.prototype,"_paletteEntity",void 0),e([me()],Oe.prototype,"_paletteValues",void 0),e([me()],Oe.prototype,"_showAdvanced",void 0),Oe=e([(e=>(t,s)=>{void 0!==s?s.addInitializer(()=>{customElements.define(e,t)}):customElements.define(e,t)})("hermes-card")],Oe),window.customCards=window.customCards||[],window.customCards.push({type:"hermes-card",name:"Hermes",description:"Meshtastic Commander control panel",preview:!1}),console.info("%c HERMES-CARD %c 0.3.0 ","background:#FFD60A;color:#000","");export{Oe as HermesCard};
