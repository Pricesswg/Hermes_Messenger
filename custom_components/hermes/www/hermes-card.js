...
`;function be(e,t){const n=e.chats[t];return n?.length?n[n.length-1].ts:""}function we(e,t,n){const i=Number(e.split(":")[1]),s=t.channels.find(e=>e.index===i);return s?`${i}: ${s.name}`:`${n("settings.channel")} ${i}`}function xe(e,t){const n=e.split(":")[1],i=t.nodes.find(e=>String(e.node_num)===n);return i?i.name:n}function ke(e,t,n,i){const s=e.chats[t]?.length??0;return F`
  ...
  `}const $e="meshtastic",Pe="hermes";function Se(e,t){const n=e.entities;return n?Object.values(n).filter(e=>e.platform===t):Object.keys(e.states).filter(e=>e.includes(t)).map(e=>({entity_id:e,platform:t}))}function Le(e,t){for(const n of Se(e,Pe))if(n.entity_id.endsWith(t)){const t=e.states[n.entity_id];if(t)return t}}function Te(e){return Se(e,Pe).length>0}function Ce(e,t){const n=e.devices?.[t];if(!n?.identifiers)return null;for(const e of n.identifiers)if(e?.[0]===$e){const t=Number.parseInt(String(e[1]),10);return Number.isNaN(t)?null:t}return null}function Ae(e){const t=(e.split(".")[1]??e).split("_");return t.slice(Math.max(t.length-2,0)).join(" ")}function Ee(e){const t=new Map;for(const n of Se(e,$e)){const i=n.device_id;if(!i)continue;const s=e.states[n.entity_id];if(!s)continue;let a=t.get(i);if(!a){const n=e.devices?.[i];a={deviceId:i,nodeNum:Ce(e,i),name:n?.name_by_user||n?.name||s.attributes?.friendly_name||i,values:{}},t.set(i,a)}a.values[Ae(n.entity_id)]=s}return[...t.values()].sort((e,t)=>e.name.localeCompare(t.name))}function Me(e,t){return!!e&&Date.now()-1e3*e<6e4*t}function He(e,t,n=120){if(!t)return!1;const i=e.states[t];if(!i||"unavailable"===i.state||"unknown"===i.state)return!1;const s=Date.parse(i.state);return!Number.isNaN(s)&&Date.now()-s<=60*n*1e3}const Ne=[/\{state:([^:}]+)\}/g,/\{attr:([^:}]+):[^}]+\}/g,/\{do:[^:}]+:([^:}]+?)(?::[^}]*)?\}/g];const De=["battery","voltage","snr","hops","last_heard","utilization","uptime"];function Oe(e){const t=e.attributes?.unit_of_measurement;return t?`${e.state} ${t}`:e.state}function Ie(e,t){const n=Ee(e);return n.length?F`
    ...
    <div class="grid">
      ${n.map(e=>F`
          <div class="panel">
            ...
            ${function(e){const{headline:t,rest:n}=function(e){const t=Object.entries(e),n=e=>De.findIndex(t=>e.toLowerCase().includes(t)),i=t.filter(([e])=>n(e)>=0).sort((e,t)=>n(e[0])-n(t[0]));return{headline:i,rest:t.filter(([e])=>n(e)<0)}}(e);return F`
    <div class="rows">
      ${[...t,...n].map(([e,t])=>F`
          <div class="row">
            <span class="k">${e}</span>
            <span class="v">${Oe(t)}</span>
          </div>
        `)}
    </div>
  `}(e.values)}
  ...
  `:F`<div class="empty">${t("devices.empty")}</div>`}const Re="missing";function qe(e,t){const n=function(e){const t=new Map,n=(e,n)=>{const i=e.trim();if(!i.includes("."))return;const s=t.get(i)??[];s.includes(n)||s.push(n),t.set(i,s)};for(const t of e)for(const e of t.commands??[]){const t=e.keyword||"?",i=e.target?.entity_id;"string"==typeof i&&n(i,t);const s=e.reply_template??"";for(const e of Ne){let i;for(e.lastIndex=0;null!==(i=e.exec(s));)n(i[1],t)}}return new Map([...t.entries()].sort((e,t)=>e[0].localeCompare(t[0])))}(e.entries),i=function(e){const t=[];for(const n of Se(e,Pe)){const i=e.states[n.entity_id];i&&t.push(i)}return t.sort((e,t)=>e.entity_id.localeCompare(t.entity_id))}(e.hass),s=[...n.entries()].map(([t,n])=>{const i=e.hass.states[t];return{entityId:t,keywords:n,state:i,status:i?"unavailable"===i.state||"unknown"===i.state?i.state:"":Re}}),a=s.filter(e=>""!==e.status).length;return F`
            ...
            <div class="rows">
              ${s.map(e=>F`
                  <div class="row">
                    ...
                    <span class="v">
                      ${e.status===Re?t("ha.missing"):e.state?Oe(e.state):""}
                    </span>
                  </div>
                `)}
            </div>
  ...
  `}function Be(e,t){const n=e.filter?e.entries.filter(t=>t.direction===e.filter):e.entries;return F`
  ...
  `,e([me({attribute:!1})],Ve.prototype,"hass",void 0),e([me()],Ve.prototype,"value",void 0),e([me()],Ve.prototype,"placeholder",void 0),e([me({attribute:!1})],Ve.prototype,"domains",void 0),e([ge()],Ve.prototype,"_query",void 0),e([ge()],Ve.prototype,"_open",void 0),e([ge()],Ve.prototype,"_active",void 0),Ve=e([he("hermes-entity-picker")],Ve);const Qe=[{id:"turn_on",label:"Turn on",service:"homeassistant.turn_on"},{id:"turn_off",label:"Turn off",service:"homeassistant.turn_off"},{id:"toggle",label:"Toggle",service:"homeassistant.toggle"}];let Ye={light:[{id:"turn_on",label:"Turn on",service:"light.turn_on"},{id:"turn_on_brightness",label:"Turn on at brightness",service:"light.turn_on",value:{key:"brightness_pct",type:"number",unit:"%",min:1,max:100,step:1,default:80}},{id:"turn_off",label:"Turn off",service:"light.turn_off"},{id:"toggle",label:"Toggle",service:"light.toggle"}],switch:Qe,climate:[{id:"set_temperature",label:"Set temperature",service:"climate.set_temperature",value:{key:"temperature",type:"number",unit:"C",min:5,max:35,step:.5,default:21}},{id:"turn_on",label:"Turn on",service:"climate.turn_on"},{id:"turn_off",label:"Turn off",service:"climate.turn_off"}],cover:[{id:"open",label:"Open",service:"cover.open_cover"},{id:"close",label:"Close",service:"cover.close_cover"},{id:"stop",label:"Stop",service:"cover.stop_cover"},{id:"set_position",label:"Set position",service:"cover.set_cover_position",value:{key:"position",type:"number",unit:"%",min:0,max:100,step:5,default:100}}]},Je={light:"light",switch:"switch",input_boolean:"switch",climate:"climate",cover:"cover"},Xe=Qe;function et(e){return e.split(".")[0]??""}function tt(e){const t=Object.entries(e??{}).filter(([e,t])=>e&&t&&!/[,={}|]/.test(t)).map(([e,t])=>`${e}=${t}`);return t.length?`|${t.join(",")}`:""}const nt={light:["on","off"],switch:["on","off"],fan:["on","off"],siren:["on","off"],input_boolean:["on","off"],automation:["on","off"],binary_sensor:["on","off"],lock:["locked","unlocked","open"],cover:["open","closed","opening","closing"],person:["home","not_home"],device_tracker:["home","not_home"],alarm_control_panel:["disarmed","armed_home","armed_away","triggered"],media_player:["playing","paused","idle","off"],vacuum:["cleaning","docked","returning","paused","idle"],water_heater:["eco","performance","off"]};const it={temperature:{min:"min_temp",max:"max_temp",step:"target_temp_step"},percentage:{step:"percentage_step"},value:{min:"min",max:"max",step:"step"}},st={hvac_mode:"hvac_modes",preset_mode:"preset_modes",fan_mode:"fan_modes",swing_mode:"swing_modes",operation_mode:"operation_list",source:"source_list"};function at(e,t,n){const i=e.states[t]?.attributes??{},s={...n},a=it[n.key]??{};for(const e of["min","max","step"]){const t=a[e],n=t?i[t]:void 0;"number"==typeof n&&(s[e]=n)}const o=st[n.key],r=o?i[o]:void 0;return Array.isArray(r)&&r.length&&(s.options=r.map(String),void 0!==s.default&&s.options.includes(String(s.default))||(s.default=s.options[0])),"number"==typeof s.default&&("number"==typeof s.min&&s.default<s.min&&(s.default=s.min),"number"==typeof s.max&&s.default>s.max&&(s.default=s.max)),s}const ot=new Set(["friendly_name","icon","supported_features","device_class","entity_picture","attribution","supported_color_modes","hs_color","rgb_color","xy_color"]);function rt(e,t,n){if("channel"!==t.mode)return n("messages.onDm");const i=t.channel_index??0,s=e.channels.find(e=>e.index===i);return s?`${i}: ${s.name}`:`${n("settings.channel")} ${i}`}function lt(e,t){if(e.loadError)return F`
      <div class="empty">
    ...
    <div class="palette">
      ...
      ${n&&e.hass.states[n]?F`
            ...
            <div class="chips">
              <button
                class="chip read"
                @click=${()=>e.onInsert(function(e,t){return`{state:${e}${tt(t)}}`}(n,e.paletteLabels))}
              >
                ${t("messages.readState")}
              </button>
              ${function(e,t){const n=e.states[t];return n?.attributes?Object.entries(n.attributes).filter(([e,t])=>!ot.has(e)&&("string"==typeof t||"number"==typeof t||"boolean"==typeof t)).map(([e])=>e).sort():[]}(e.hass,n).map(t=>F`
                  <button
                    class="chip read"
                    @click=${()=>e.onInsert(function(e,t,n){return`{attr:${e}:${t}${tt(n)}}`}(n,t))}
                  >
                    ${t}
                  </button>
                `)}
            ...
            ${function(e,t,n){const i=function(e,t){const n=e?.options??e?.hvac_modes??e?.effect_list;return Array.isArray(n)&&n.length&&n.length<=12?n.map(String):nt[et(t)]??[]}(e.hass.states[t]?.attributes,t);return i.length?F`
    <div class="labels">
  ...
  `:F``}(e,n,t)}
            ...
            <div class="chips">
              ${function(e){const t=Je[et(e)];return t&&Ye[t]||Xe}(n).map(t=>F`
                  <span class="chip-group">
                    <button
                      class="chip do"
                      @click=${()=>e.onInsert(function(e,t,n){return e.value&&void 0!==n&&""!==n?`{do:${e.service}:${t}:${e.value.key}=${n}}`:`{do:${e.service}:${t}}`}(t,n,e.paletteValues[t.id]??(t.value?at(e.hass,n,t.value).default:void 0)))}
                    >
                      ${t.label}
                    </button>
                    ${function(e,t,n){if(!t.value)return"";const i=at(e.hass,n,t.value),s=e.paletteValues[t.id]??i.default??"";if("enum"===i.type)return F`
      <select
        class="inline"
  ...
  `}(e,e.editing,t):F`
    ...
    ${i.map((o,r)=>{const l=(o.group??"").trim(),c=s&&l!==a?F`<div class="section-title group-head">
            ...
            </div>`:"";return a=l,F`${c}${function(e,t,n,i,s=0,a=1){const o=t.service||t.reply_template||"",r=t.reply_channel,l=null!=r?e.channels.find(e=>e.index===r):void 0,c="sender_dm"===t.reply_to?i("messages.onDm"):null!=r?`${r}${l?`: ${l.name}`:""}`:rt(e,n,i);return F`
    <div class="list-row">
      <div class="meta">
  ...
  `}(e,n,t)}
        `}
  `}const ct=[{key:"require_pkc",label:"security.requirePkc",hint:"security.requirePkcHint"},{key:"reject_mqtt",label:"security.rejectMqtt",hint:"security.rejectMqttHint"}];function dt(e,t){if(!e.entries.length)return F``;const n=e.entries.some(e=>!e.require_pkc||e.channel_risk_ack?.accepted);return F`
    ...
    <div class="danger-entry">
      ...
      ${ct.map(i=>function(e,t,n,i){const s=Boolean(t[n.key]),a=`${t.entry_id}:${n.key}`,o=e.armed===a;return F`
  ...
  `}(e,e.riskDialog,t):""}
  `}function ht(e){return e.filter(e=>"mesh"!==e.source)}function ut(e,t,n,i,s=null){if(s)return F`<div class="sub-error">${s}</div>`;if(!e.length)return F`<div class="hint">${i}</div>`;const a=new Set((t??[]).map(Number));return F`
    <div class="checklist">
      ${e.map(e=>F`
          <label class="check">
            <input
  ...
  `}function pt(e,t){const n=e.settings,i=t=>e.draftGlobal[t]??n?.[t];return F`
    <h2 class="screen-title">
      ${t("settings.title")}
      <button
        class="btn refresh"
    ...
    <div class="section">
      ...
      <div class="panel">
        ...
        <div class="field">
          ...
          ${ut(e.nodes,i("map_nodes")??[],t=>e.onGlobalInput("map_nodes",t),t("settings.noNodes"),e.nodesError)}
  ...
  `}(e,t,n):""}
        ...
        <div class="field">
          ...
          ${ut(e.nodes,s("authorized_nodes",t.authorized_nodes)??[],n=>e.onEntryInput(t.entry_id,"authorized_nodes",n),n("settings.noNodes"),e.nodesError)}
  ...
  `}(e,n,t))}
  `}const mt="1.3.0";function gt(e,t,n,i,s){if(!Te(e))return F`<div class="empty">${s("status.noIntegration")}</div>`;const a=Ee(e),o=Le(e,"commands_executed"),r=Le(e,"last_command"),l=Le(e,"last_error"),c=e=>e&&"unknown"!==e&&"unavailable"!==e?e:s("status.none");return F`
    <h2 class="screen-title">
      ${s("status.title")}
    ...
    <div class="section" style="margin-top:18px">
      ...
      <div class="panel">
        ...
        <div class="rows">
          ...
          ${e.backend_version&&e.backend_version!==mt?F`<div class="note warn">${t("status.versionMismatch")}</div>`:""}
          <div class="row">
  ...
  `}(e,s))}
  `}function ft(e,t){return e.callWS({type:"hermes/settings/update",patch:t})}function _t(e){return e.callWS({type:"hermes/entries/list"})}function vt(e,t,n){return e.callWS({type:"hermes/entry/update",entry_id:t,patch:n})}function yt(e){return e.callWS({type:"hermes/presets/list"})}function bt(e){return e.callWS({type:"hermes/history/list"})}function wt(e){return e.callWS({type:"hermes/chats/list"})}const xt=["status","chat","log","devices","map","messages","homeassistant","settings"],kt=["full","summary","chat"],zt={keyword:"",match_type:"exact",service:"",reply_template:"",reply_to:"channel"};let $t=class extends ce{constructor(){super(...arguments),this._tab="status",this._view="full",this._entries=[],this._nodes=[],this._settings=null,this._saved=!1,this._draftGlobal={},this._draftEntries={},this._selectedEntry=null,this._editing=null,this._loadError=null,this._paletteEntity="",this._paletteValues={},this._paletteLabels={},this._showAdvanced=!1,this._mapShowAll=!1,this._mapRadiusOn=!1,this._mapRadiusKm=25,this._presets=[],this._editingPreset=null,this._history=[],this._logFilter="",this._testText="",this._sendingTest=!1,this._channels=[],this._firmware=null,this._radio=null,this._nodesError=null,this._refreshing=!1,this._updatedAt="",this._chats={},this._chatThread=null,this._chatDraft="",this._chatSending=!1,this._radioConfig=null,this._radioDraft={},this._radioSaving=!1,this._radioError=null,this._armed=null,this._riskDialog=null,this._loaded=!1,this._onGlobalInput=(e,t)=>{this._draftGlobal={...this._draftGlobal,[e]:t}},this._onEntryInput=(e,t,n)=>{this._draftEntries={...this._draftEntries,[e]:{...this._draftEntries[e]??{},[t]:n}}},this._onSaveGlobal=async()=>{this.hass&&Object.keys(this._draftGlobal).length&&(this._settings=await ft(this.hass,this._draftGlobal),this._draftGlobal={},this._flagSaved())},this._onSaveEntry=async e=>{const t=this._draftEntries[e];this.hass&&t&&Object.keys(t).length&&(await vt(this.hass,e,t),this._draftEntries={...this._draftEntries,[e]:{}},this._flagSaved(),await this._load())},this._onSelectEntry=e=>{this._selectedEntry=e,this._editing=null},this._onNew=()=>{this._editing={...zt}},this._onEdit=e=>{this._editing={...e}},this._onDuplicate=e=>{const{id:t,...n}=e;this._editing={...n,keyword:`${e.keyword} 2`}},this._onDraftInput=(e,t)=>{this._editing&&(this._editing={...this._editing,[e]:t})},this._onCancel=()=>{this._editing=null},this._onPaletteEntity=e=>{this._paletteEntity=e,this._paletteLabels={}},this._onPaletteValue=(e,t)=>{this._paletteValues={...this._paletteValues,[e]:t}},this._onPaletteLabel=(e,t)=>{this._paletteLabels={...this._paletteLabels,[e]:t}},this._onToggleAdvanced=()=>{this._showAdvanced=!this._showAdvanced},this._onPresetNew=()=>{this._editingPreset={label:"",text:"",node_id:null,channel:null}},this._onPresetEdit=e=>{this._editingPreset={...e}},this._onPresetInput=(e,t)=>{this._editingPreset&&(this._editingPreset={...this._editingPreset,[e]:t})},this._onPresetCancel=()=>{this._editingPreset=null},this._onPresetSave=async()=>{var e,t;this.hass&&this._editingPreset?.text&&(await(e=this.hass,t=this._editingPreset,e.callWS({type:"hermes/presets/save",preset:t})),this._editingPreset=null,this._presets=await yt(this.hass),this._flagSaved())},this._onPresetDelete=async e=>{var t,n;this.hass&&e.id&&(await(t=this.hass,n=e.id,t.callWS({type:"hermes/presets/remove",preset_id:n})),this._presets=await yt(this.hass))},this._onPresetSend=async e=>{const t=this._selectedEntry??this._entries[0]?.entry_id;this.hass&&t&&e.id&&(await function(e,t,n){return e.callWS({type:"hermes/presets/send",entry_id:t,preset_id:n})}(this.hass,t,e.id),this._flagSaved(),this._history=await bt(this.hass))},this._onTestText=e=>{this._testText=e},this._onSendTest=async()=>{const e=this._selectedEntry??this._entries[0]?.entry_id;if(this.hass&&e&&this._testText){this._sendingTest=!0;try{await this.hass.callService("hermes","broadcast",{config_entry_id:e,message:this._testText}),this._flagSaved(),this._history=await bt(this.hass)}catch(e){console.error("Hermes: test send failed",e)}finally{this._sendingTest=!1}}},this._onRadioInput=(e,t)=>{this._radioDraft={...this._radioDraft,[e]:t},this._radioError=null},this._onRadioSave=async()=>{if(this.hass&&Object.keys(this._radioDraft).length){this._radioSaving=!0,this._radioError=null;try{this._radioConfig=await(e=this.hass,t=this._radioDraft,e.callWS({type:"hermes/radio/config/set",patch:t})),this._radioDraft={},this._flagSaved()}catch(e){this._radioError=String(e?.message??e)}finally{this._radioSaving=!1}var e,t}},this._onChatSelect=e=>{this._chatThread=e},this._onChatDraft=e=>{this._chatDraft=e},this._onChatSend=async()=>{const e=this._selectedEntry??this._entries[0]?.entry_id,t=this._chatThread??Object.keys(this._chats)[0];if(this.hass&&e&&t&&this._chatDraft.trim()){this._chatSending=!0;try{await function(e,t,n,i){return e.callWS({type:"hermes/chats/send",entry_id:t,thread:n,message:i})}(this.hass,e,t,this._chatDraft.trim()),this._chatDraft="",this._chats=await wt(this.hass)}catch(e){console.error("Hermes: could not send the message",e)}finally{this._chatSending=!1}}},this._onChatClear=async e=>{this.hass&&(await function(e,t){return e.callWS({type:"hermes/chats/clear",thread:t})}(this.hass,e),this._chats=await wt(this.hass))},this._onLogFilter=e=>{this._logFilter=e},this._onLogClear=async()=>{var e;this.hass&&(await(e=this.hass,e.callWS({type:"hermes/history/clear"})),this._history=[])},this._onToggleShowAll=()=>{this._mapShowAll=!this._mapShowAll},this._onToggleRadius=()=>{this._mapRadiusOn=!this._mapRadiusOn},this._onRadiusChange=e=>{this._mapRadiusKm=e},this._onSecurityToggle=async(e,t,n)=>{this.hass&&(await vt(this.hass,e,{[t]:n}),this._flagSaved(),await this._load())},this._onSecurityNumber=async(e,t,n)=>{this.hass&&(await vt(this.hass,e,{[t]:n}),this._flagSaved(),await this._load())},this._onArm=e=>{this._armed=e,e&&window.setTimeout(()=>{this._armed===e&&(this._armed=null)},5e3)},this._onOpenRisk=e=>{this._riskDialog=e},this._onAcceptRisk=async e=>{this.hass&&(await vt(this.hass,e,{channel_risk_ack:!0}),this._flagSaved(),await this._load())},this._onRevokeRisk=async e=>{this.hass&&(await vt(this.hass,e,{channel_risk_ack:!1}),this._flagSaved(),await this._load())},this._onPickChannel=e=>{this._tab="settings",this._selectedEntry=e},this._onRefresh=async()=>{this._refreshing=!0;try{await this._load()}finally{this._refreshing=!1}},this._onHeightChange=async e=>{this.hass&&(this._settings=await ft(this.hass,{map_height:e}))},this._onInsert=e=>{if(!this._editing)return;const t=this.renderRoot.querySelector("#hermes-template"),n=this._editing.reply_template??"";if(!t)return void(this._editing={...this._editing,reply_template:n+e});const i=t.selectionStart??n.length,s=t.selectionEnd??n.length,a=n.slice(0,i)+e+n.slice(s);this._editing={...this._editing,reply_template:a},this.updateComplete.then(()=>{const t=this.renderRoot.querySelector("#hermes-template");if(t){const n=i+e.length;t.focus(),t.setSelectionRange(n,n)}})},this._onSaveCommand=async()=>{const e=this._selectedEntry;if(!this.hass||!e||!this._editing)return;const t=Boolean(this._editing.service)||Boolean(this._editing.reply_template);this._editing.keyword&&t&&(await function(e,t,n){return e.callWS({type:"hermes/commands/save",entry_id:t,command:n})}(this.hass,e,this._editing),this._editing=null,this._flagSaved(),await this._load())},this._onMoveCommand=async(e,t)=>{const n=this._selectedEntry??this._entries[0]?.entry_id,i=this._entries.find(e=>e.entry_id===n);if(!this.hass||!i||!e.id)return;const s=i.commands.map(e=>e.id??""),a=s.indexOf(e.id),o=a+t;a<0||o<0||o>=s.length||(s.splice(o,0,s.splice(a,1)[0]),await function(e,t,n){return e.callWS({type:"hermes/commands/reorder",entry_id:t,order:n})}(this.hass,i.entry_id,s),this._flagSaved(),await this._load())},this._onDeleteCommand=async e=>{const t=this._selectedEntry;this.hass&&t&&e.id&&(await function(e,t,n){return e.callWS({type:"hermes/commands/remove",entry_id:t,command_id:n})}(this.hass,t,e.id),this._flagSaved(),await this._load())}}setConfig(e){this._config=e,e?.tab&&xt.includes(e.tab)&&(this._tab=e.tab),this._view=kt.includes(e?.view)?e.view:"full",this.toggleAttribute("compact","full"!==this._view)}getCardSize(){return 12}connectedCallback(){super.connectedCallback(),this._subscribe(),this._pollTimer=window.setInterval(()=>{this._poll()},15e3)}disconnectedCallback(){super.disconnectedCallback(),this._pollTimer&&(window.clearInterval(this._pollTimer),this._pollTimer=void 0),this._unsubscribe&&(this._unsubscribe(),this._unsubscribe=void 0)}async _subscribe(){const e=this.hass?.connection;if(e?.subscribeEvents&&!this._unsubscribe)try{this._unsubscribe=await e.subscribeEvents(()=>{this._poll(!0)},"meshtastic_api_text_message")}catch(e){console.warn("Hermes: live updates unavailable, falling back to polling",e)}}async _poll(e=!1){if(this.hass&&this._loaded&&(e||"status"===this._tab||"log"===this._tab||"chat"===this._tab))try{this._entries=await _t(this.hass),"full"===this._view&&(this._history=await bt(this.hass)),"summary"!==this._view&&(this._chats=await wt(this.hass)),this._updatedAt=(new Date).toLocaleTimeString()}catch(e){console.warn("Hermes: refresh failed",e)}}firstUpdated(){let e=this.parentElement;for(;e;){if("HUI-PANEL-VIEW"===e.tagName){this.setAttribute("panel-mode","");break}e=e.parentElement}}updated(){this.hass&&!this._loaded&&(this._loaded=!0,this._load())}async _load(e=0){if(this.hass){try{const e=await _t(this.hass);this._entries=e,this._loadError=null,!this._selectedEntry&&e.length&&(this._selectedEntry=e[0].entry_id)}catch(t){if(e<3)return void window.setTimeout(()=>{this._load(e+1)},500*(e+1));this._loadError=String(t?.message??t),console.error("Hermes: failed to load gateways",t)}try{this._nodes=await(t=this.hass,t.callWS({type:"hermes/nodes/list"})),this._nodesError=null}catch(e){this._nodesError=String(e?.message??e),console.error("Hermes: failed to load nodes",e)}var t;try{this._channels=await function(e){return e.callWS({type:"hermes/channels/list"})}(this.hass)}catch(e){console.warn("Hermes: could not read the radio channels",e)}try{const e=await function(e){return e.callWS({type:"hermes/radio/info"})}(this.hass);this._radio=e,this._firmware=e.firmware}catch{this._firmware=null}try{this._chats=await wt(this.hass)}catch(e){console.error("Hermes: failed to load the conversations",e)}if("full"===this._view){try{n=await function(e){return e.callWS({type:"hermes/actions"})}(this.hass),n?.by_type&&(Ye=n.by_type),n?.domain_to_type&&(Je=n.domain_to_type),n?.generic&&(Xe=n.generic)}catch(e){console.warn("Hermes: using the built-in action catalogue",e)}var n;try{this._presets=await yt(this.hass)}catch(e){console.error("Hermes: failed to load presets",e)}try{this._history=await bt(this.hass)}catch(e){console.error("Hermes: failed to load the log",e)}try{this._radioConfig=await function(e){return e.callWS({type:"hermes/radio/config/get"})}(this.hass)}catch(e){console.warn("Hermes: could not read the radio configuration",e)}try{this._settings=await function(e){return e.callWS({type:"hermes/settings/get"})}(this.hass)}catch{this._settings=null}}}}_flagSaved(){this._saved=!0,window.setTimeout(()=>{this._saved=!1},2e3)}_select(e){this._tab=e,this._load()}_screen(e){const t=this.hass;switch(this._tab){case"status":default:return gt(t,this._entries,this._updatedAt,this._radio,e);case"chat":return ze({chats:this._chats,channels:this._channels,nodes:this._nodes,thread:this._chatThread,draft:this._chatDraft,sending:this._chatSending,onSelect:this._onChatSelect,onDraft:this._onChatDraft,onSend:this._onChatSend,onClear:this._onChatClear},e);case"log":return Be({entries:this._history,entries_meta:this._entries.map(e=>({title:e.title,counts:e.seen_counts??{}})),filter:this._logFilter,updatedAt:this._updatedAt,onFilter:this._onLogFilter,onClear:this._onLogClear,onRefresh:()=>{this._poll(!0)}},e);case"devices":return Ie(t,e);case"map":return Ke({hass:t,settings:this._settings,authorized:[...new Set(this._entries.flatMap(e=>e.authorized_nodes??[]))],meshNodes:this._nodes,showAll:this._mapShowAll,radiusOn:this._mapRadiusOn,radiusKm:this._mapRadiusKm,onToggleShowAll:this._onToggleShowAll,onToggleRadius:this._onToggleRadius,onRadiusChange:this._onRadiusChange,onHeightChange:this._onHeightChange},e);case"messages":return lt({hass:t,entries:this._entries,selectedEntry:this._selectedEntry,editing:this._editing,loadError:this._loadError,paletteEntity:this._paletteEntity,paletteValues:this._paletteValues,paletteLabels:this._paletteLabels,showAdvanced:this._showAdvanced,onSelectEntry:this._onSelectEntry,onNew:this._onNew,onEdit:this._onEdit,onDuplicate:this._onDuplicate,onDelete:this._onDeleteCommand,onMove:this._onMoveCommand,onDraftInput:this._onDraftInput,onPaletteEntity:this._onPaletteEntity,onPaletteValue:this._onPaletteValue,onPaletteLabel:this._onPaletteLabel,onInsert:this._onInsert,onToggleAdvanced:this._onToggleAdvanced,onSave:this._onSaveCommand,onCancel:this._onCancel,channels:this._channels,presets:this._presets,editingPreset:this._editingPreset,onPresetNew:this._onPresetNew,onPresetEdit:this._onPresetEdit,onPresetDelete:this._onPresetDelete,onPresetInput:this._onPresetInput,onPresetSave:this._onPresetSave,onPresetCancel:this._onPresetCancel,onPresetSend:this._onPresetSend},e);case"homeassistant":return qe({hass:t,entries:this._entries,testText:this._testText,selectedEntry:this._selectedEntry,sending:this._sendingTest,onTestText:this._onTestText,onSendTest:this._onSendTest},e);case"settings":return F`
          ${dt({entries:this._entries,armed:this._armed,riskDialog:this._riskDialog,onToggle:this._onSecurityToggle,onArm:this._onArm,onNumber:this._onSecurityNumber,onOpenRisk:this._onOpenRisk,onAcceptRisk:this._onAcceptRisk,onRevokeRisk:this._onRevokeRisk,onPickChannel:this._onPickChannel},e)}
          ${this._renderSettings(e)}
        `}}_renderSettings(e){return pt({settings:this._settings,entries:this._entries,nodes:this._nodes,channels:this._channels,firmware:this._firmware,nodesError:this._nodesError,refreshing:this._refreshing,onRefresh:this._onRefresh,saved:this._saved,loadError:this._loadError,draftGlobal:this._draftGlobal,draftEntries:this._draftEntries,onGlobalInput:this._onGlobalInput,onEntryInput:this._onEntryInput,radioConfig:this._radioConfig,radioDraft:this._radioDraft,radioSaving:this._radioSaving,radioError:this._radioError,onRadioInput:this._onRadioInput,onRadioSave:this._onRadioSave,onSaveGlobal:this._onSaveGlobal,onSaveEntry:this._onSaveEntry},e)}_compact(e){const t=this.hass;return"chat"===this._view?ze({chats:this._chats,channels:this._channels,nodes:this._nodes,thread:this._chatThread,draft:this._chatDraft,sending:this._chatSending,onSelect:this._onChatSelect,onDraft:this._onChatDraft,onSend:this._onChatSend,onClear:this._onChatClear},e):function(e,t,n,i,s){if(!Te(e))return F`<div class="empty">${s("status.noIntegration")}</div>`;const a=e=>e&&"unknown"!==e&&"unavailable"!==e?e:s("status.none"),o=Le(e,"commands_executed"),r=Le(e,"last_command"),l=Le(e,"last_error"),c=t.some(e=>!1===e.radio_connected),d=t.reduce((e,t)=>e+(t.seen_counts?.received??0),0),h=t.reduce((e,t)=>e+(t.seen_counts?.accepted??0),0),u=[[s("summary.link"),s(c?"status.radioOfflineBadge":"summary.linkUp")],[s("status.nodes"),Ee(e).length],[s("summary.received"),d],[s("summary.accepted"),h],[s("status.executed"),o?o.state:"0"],[s("status.lastCommand"),a(r?.state)],[s("status.lastError"),a(l?.state)]];return i?.long_name&&u.splice(1,0,[s("radio.name"),i.long_name]),F`
  ...
  `}(t,this._entries,this._updatedAt,this._radio,e)}render(){if(!this.hass||!this._config)return F``;const e=function(e){const t=(e?.locale?.language||e?.language||"en").split("-")[0].toLowerCase(),n=_e[t]||fe;return e=>n[e]??fe[e]??e}(this.hass);return"full"!==this._view?F`
    ...
    `}};$t.styles=[ve,ye],e([me({attribute:!1})],$t.prototype,"hass",void 0),e([ge()],$t.prototype,"_config",void 0),e([ge()],$t.prototype,"_tab",void 0),e([ge()],$t.prototype,"_view",void 0),e([ge()],$t.prototype,"_entries",void 0),e([ge()],$t.prototype,"_nodes",void 0),e([ge()],$t.prototype,"_settings",void 0),e([ge()],$t.prototype,"_saved",void 0),e([ge()],$t.prototype,"_draftGlobal",void 0),e([ge()],$t.prototype,"_draftEntries",void 0),e([ge()],$t.prototype,"_selectedEntry",void 0),e([ge()],$t.prototype,"_editing",void 0),e([ge()],$t.prototype,"_loadError",void 0),e([ge()],$t.prototype,"_paletteEntity",void 0),e([ge()],$t.prototype,"_paletteValues",void 0),e([ge()],$t.prototype,"_paletteLabels",void 0),e([ge()],$t.prototype,"_showAdvanced",void 0),e([ge()],$t.prototype,"_mapShowAll",void 0),e([ge()],$t.prototype,"_mapRadiusOn",void 0),e([ge()],$t.prototype,"_mapRadiusKm",void 0),e([ge()],$t.prototype,"_presets",void 0),e([ge()],$t.prototype,"_editingPreset",void 0),e([ge()],$t.prototype,"_history",void 0),e([ge()],$t.prototype,"_logFilter",void 0),e([ge()],$t.prototype,"_testText",void 0),e([ge()],$t.prototype,"_sendingTest",void 0),e([ge()],$t.prototype,"_channels",void 0),e([ge()],$t.prototype,"_firmware",void 0),e([ge()],$t.prototype,"_radio",void 0),e([ge()],$t.prototype,"_nodesError",void 0),e([ge()],$t.prototype,"_refreshing",void 0),e([ge()],$t.prototype,"_updatedAt",void 0),e([ge()],$t.prototype,"_chats",void 0),e([ge()],$t.prototype,"_chatThread",void 0),e([ge()],$t.prototype,"_chatDraft",void 0),e([ge()],$t.prototype,"_chatSending",void 0),e([ge()],$t.prototype,"_radioConfig",void 0),e([ge()],$t.prototype,"_radioDraft",void 0),e([ge()],$t.prototype,"_radioSaving",void 0),e([ge()],$t.prototype,"_radioError",void 0),e([ge()],$t.prototype,"_armed",void 0),e([ge()],$t.prototype,"_riskDialog",void 0),$t=e([he("hermes-card")],$t);let Pt=class extends $t{setConfig(e){super.setConfig({...e,view:"summary"})}getCardSize(){return 4}};Pt=e([he("hermes-summary-card")],Pt);let St=class extends $t{setConfig(e){super.setConfig({...e,view:"chat"})}getCardSize(){return 8}};St=e([he("hermes-chat-card")],St),window.customCards=window.customCards||[],window.customCards.push({type:"hermes-card",name:"Hermes",description:"Meshtastic Commander control panel",preview:!1},{type:"hermes-summary-card",name:"Hermes summary",description:"Hermes status as a list of parameters, for a dashboard column",preview:!1},{type:"hermes-chat-card",name:"Hermes chat",description:"Send and read Meshtastic messages, channels and direct",preview:!1}),console.info(`%c HERMES-CARD %c ${mt} `,"background:#FFD60A;color:#000","");export{$t as HermesCard,St as HermesChatCard,Pt as HermesSummaryCard};
